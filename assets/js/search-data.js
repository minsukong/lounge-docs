window.LOUNGE_GUIDE_SEARCH_INDEX = [
  {
    ...
    "url": "./../ui_guide/design_tokens.html#section-9"
  },
  {
    "document": "디자인 토큰 가이드",
    "section": "목적과 범위",
    ...
    "url": "./../ui_guide/design_tokens.html#section-1"
  },
  {
    "document": "디자인 토큰 가이드",
    "section": "변경과 동기화",
    ...
    "url": "./../ui_guide/design_tokens.html#section-8"
  },
  {
    "document": "디자인 토큰 가이드",
    "section": "토큰 분류와 이름",
    ...
    "url": "./../ui_guide/design_tokens.html#section-4"
  },
  {
    "document": "디자인 토큰 가이드",
    "section": "토큰 연결 구조",
    ...
    "url": "./../ui_guide/design_tokens.html#section-3"
  },
  {
    "document": "디자인 토큰 가이드",
    "section": "현재 프로젝트 기준",
    ...
    "url": "./../ui_guide/design_tokens.html#section-2"
  },
  {
    "document": "디자인 토큰 가이드",
    ...
    "url": "./../ui_guide/design_tokens.html#section-6"
  },
  {
    "document": "디자인 토큰 가이드",
    ...
    "url": "./../ui_guide/design_tokens.html#section-7"
  },
  {
    "document": "디자인 토큰 가이드",
    ...
    "url": "./../ui_guide/design_tokens.html#section-5"
  },
  {
    ...
    "url": "./../app/webView/webView_overview.html#section-8"
  },
  {
    "document": "모바일 앱 WebView 개요",
    ...
    "url": "./../app/webView/webView_overview.html#section-1"
  },
  {
    "document": "모바일 앱 WebView 개요",
    ...
    "url": "./../app/webView/webView_overview.html#section-3"
  },
  {
    "document": "모바일 앱 WebView 개요",
    "section": "자주 묻는 질문",
    ...
    "url": "./../app/webView/webView_overview.html#section-11"
  },
  {
    "document": "모바일 앱 WebView 개요",
    ...
    "url": "./../app/webView/webView_overview.html#section-9"
  },
  {
    "document": "모바일 앱 WebView 개요",
    "section": "지원 환경",
    "excerpt": "신규 모바일 프로젝트는 다음 환경을 기준으로 검토합니다. 플랫폼 최소 환경 확인 기준 Android Android SDK 24 이상, System WebView 111 이상 Android 버전과 Chromium 기반 WebView 버전 iOS iOS 16.4 이상 iOS 버전에서 제공되는 WKWebView 특정 Chrome 또는 Safari 버전을 WebView 지원 기준으로 사용하지 않습니…",
    "content": "6. 지원 환경 신규 모바일 프로젝트는 다음 환경을 기준으로 검토합니다. 플랫폼 최소 환경 확인 기준 Android Android SDK 24 이상, System WebView 111 이상 Android 버전과 Chromium 기반 WebView 버전 iOS iOS 16.4 이상 iOS 버전에서 제공되는 WKWebView 특정 Chrome 또는 Safari 버전을 WebView 지원 기준으로 사용하지 않습니다. 실제 지원 기기와 운영체제에서 서비스의 주요 기능이 정상 동작하는지 확인합니다. 최소 기준을 정한 근거 주요 서비스 국가는 한국·중국·일본·미국이며 그 밖의 국가는 글로벌 기준으로 검토합니다. 2026년 7월 StatCounter 모바일 트래픽에서 Android와 iOS의 비중은 한국 65.39%·34.60%, 중국 70.37%·29.51%, 일본 36.41%·63.59%, 미국 40.39%·59.58%, 전 세계 68.36%·31.60%입니다. 따라서 Android 중심 국가와 iOS 중심 국가를 모두 지원해야 하며, 한 국가의 통계만으로 전체 지원 범위를 판단하지 않습니다. 한국 모바일 OS 점유율 중국 모바일 OS 점유율 일본 모바일 OS 점유율 미국 모바일 OS 점유율 전 세계 모바일 OS 점유율 Google이 2025년 12월 공개한 Android 배포 데이터에서 API 21~23의 합계는 0.8%이므로 API 24 이상은 약 99.2%입니다. 이 수치는 Google의 Android 활성 기기 분포이며 중국 시장 또는 이 서비스의 실제 고객 분포와 같다고 보지 않습니다. Google Android 버전 배포 원본 데이터 에서 조사일과 API별 비율을 확인합니다. Apple이 2026년 6월 7일 App Store에서 거래한 기기를 집계한 결과 전체 iPhone의 79%가 iOS 26을 사용합니다. 이는 iOS 16.4 이상 비율의 전체값은 아니지만 최소한 79%가 현재 기준보다 높은 버전을 사용한다는 공식 근거입니다. 자세한 내용은 Apple iOS 사용 현황 에서 확인합니다. 공개 점유율은 기준 선정의 참고 자료입니다. 출시 후에는 국가·OS·Android WebView 엔진별 실제 활성 사용자 분포와 오류율을 우선 근거로 사용합니다.",
    "url": "./../app/webView/webView_overview.html#section-6"
  },
  {
    "document": "모바일 앱 WebView 개요",
    ...
    "url": "./../app/webView/webView_overview.html#section-10"
  },
  {
    "document": "모바일 앱 WebView 개요",
    ...
    "url": "./../app/webView/webView_overview.html#section-7"
  },
  {
    "document": "모바일 앱 WebView 개요",
    ...
    "url": "./../app/webView/webView_overview.html#section-5"
  },
  {
    "document": "모바일 앱 WebView 개요",
    ...
    "url": "./../app/webView/webView_overview.html#section-2"
  },
  {
    "document": "모바일 앱 WebView 개요",
    ...
    "url": "./../app/webView/webView_overview.html#section-4"
  },
  {
    ...
    "url": "./../browser_support_guide/index.html#section-8"
  },
  {
    "document": "반응형 웹 브라우저 지원 가이드",
    "section": "기기 구분별 필수 검증 환경",
    "excerpt": "구분 최소 버전 검증 최신 버전 검증 국가별 추가 검증 PC Chrome 111, Edge 111, Firefox 128, Safari 16.4 각 브라우저 최신 안정 버전 한국 Whale, 중국 360 Safe·UC·QQ 최신 안정 버전 태블릿 iPadOS Safari 16.4, Android Chrome 111, Samsung Internet 23 iPadOS·Android 주요 브라우저…",
    "content": "6. 기기 구분별 필수 검증 환경 구분 최소 버전 검증 최신 버전 검증 국가별 추가 검증 PC Chrome 111, Edge 111, Firefox 128, Safari 16.4 각 브라우저 최신 안정 버전 한국 Whale, 중국 360 Safe·UC·QQ 최신 안정 버전 태블릿 iPadOS Safari 16.4, Android Chrome 111, Samsung Internet 23 iPadOS·Android 주요 브라우저 최신 안정 버전 주요 서비스 국가에서 비중이 높은 실제 태블릿 1종 이상 모바일 iOS Safari 16.4, Android Chrome 111, Samsung Internet 23 iOS·Android 주요 브라우저 최신 안정 버전 한국·중국·일본·미국의 주요 실제 단말 반응형 검증은 최소 버전 검증과 별개로 수행합니다. 프로젝트가 확정한 breakpoint의 경계값 전후, 세로·가로 화면, 확대와 글자 크기 변화에서 레이아웃을 확인합니다. 기기 이름만으로 Desktop, Tablet, Mobile 레이아웃을 고정하지 않습니다.",
    "url": "./../browser_support_guide/index.html#section-6"
  },
  {
    "document": "반응형 웹 브라우저 지원 가이드",
    "section": "기본 지원 원칙",
    "excerpt": "Tailwind CSS v4의 공식 핵심 호환 기준보다 낮은 브라우저는 지원하지 않습니다. Chromium 계열의 기술 하한은 Chromium 111입니다. Safari와 iOS·iPadOS WebKit의 기술 하한은 Safari 16.4입니다. Firefox의 기술 하한은 Firefox 128입니다. 같은 Chromium 계열도 엔진 반영 시점이 다를 수 있으므로 주요 브라우저를 각각 확인…",
    "content": "2. 기본 지원 원칙 Tailwind CSS v4의 공식 핵심 호환 기준보다 낮은 브라우저는 지원하지 않습니다. Chromium 계열의 기술 하한은 Chromium 111입니다. Safari와 iOS·iPadOS WebKit의 기술 하한은 Safari 16.4입니다. Firefox의 기술 하한은 Firefox 128입니다. 같은 Chromium 계열도 엔진 반영 시점이 다를 수 있으므로 주요 브라우저를 각각 확인합니다. 최소 버전과 최신 안정 버전에서 레이아웃과 핵심 기능을 확인합니다. Internet Explorer는 지원하지 않습니다. 자동 업데이트를 고려한 기준 Chrome, Edge와 Firefox 같은 현대 브라우저는 기본적으로 백그라운드에서 새 버전을 확인하고 자동 업데이트합니다. 모바일 브라우저도 일반적으로 앱 스토어의 자동 업데이트 설정을 따릅니다. Safari는 브라우저만 독립적으로 갱신하기보다 macOS, iOS와 iPadOS의 시스템 업데이트를 통해 함께 갱신됩니다. 따라서 2023년에 출시된 Chrome 111과 Safari 16.4를 기술 하한으로 두는 것은 일반 사용자 환경에서 과도하게 높은 기준이 아닙니다. 다만 브라우저를 오랫동안 재시작하지 않은 경우, 저장 공간이나 네트워크가 부족한 경우, 구형 OS가 최신 브라우저를 지원하지 않는 경우와 회사·학교 관리 정책으로 버전이 고정된 경우에는 업데이트가 지연되거나 중단될 수 있습니다. 자동 업데이트는 최소 버전 선택의 현실성 근거로 사용하되, 최소 버전 검증과 운영 사용자 버전 확인을 생략하는 근거로 사용하지 않습니다. 자세한 내용은 Google Chrome 업데이트 안내 , Chrome Enterprise 업데이트 관리 , Microsoft Edge 채널 안내 와 Apple Safari 업데이트 안내 를 참고합니다. Tailwind CSS v4는 핵심 기능에 @property , color-mix() 등을 사용합니다. 선택적인 최신 Utility를 사용하지 않아도 핵심 최소 버전은 낮아지지 않습니다. 더 낮은 브라우저 지원이 필요하면 Tailwind CSS 3.4 유지 또는 기술 구성 변경을 별도로 검토합니다. 자세한 기준은 Tailwind CSS 공식 호환성 문서 와 Tailwind CSS v4 업그레이드 가이드 에서 확인합니다.",
    "url": "./../browser_support_guide/index.html#section-2"
  },
  {
    "document": "반응형 웹 브라우저 지원 가이드",
    ...
    "url": "./../browser_support_guide/index.html#section-1"
  },
  {
    "document": "반응형 웹 브라우저 지원 가이드",
    ...
    "url": "./../browser_support_guide/index.html#section-4"
  },
  {
    "document": "반응형 웹 브라우저 지원 가이드",
    "section": "우선 확정 항목",
    ...
    "url": "./../browser_support_guide/index.html#section-9"
  },
  {
    "document": "반응형 웹 브라우저 지원 가이드",
    ...
    "content": "5. 점유율을 근거로 한 브라우저 선정 아래 수치는 StatCounter의 2026년 7월 PC·모바일·태블릿 통합 웹 사용량 기준입니다. 설치 대수나 당사 고객 수가 아니며, 국가별 우선 검증 제품군을 정하는 보조 근거로 사용합니다. 지역 주요 브라우저 점유율 표시 제품군 합계 근거 한국 Chrome 57.99%, Safari 11.76%, Samsung Internet 10.40%, Edge 8.99%, Whale 8.37%, Firefox 0.83% 98.34% StatCounter 한국 중국 Chrome 51.59%, Edge 16.35%, Safari 14.44%, 360 Safe 4.88%, UC 4.85%, QQ 3.69% 95.80% StatCounter 중국 일본 Chrome 55.96%, Safari 23.21%, Edge 14.42%, Firefox 2.84%, Brave 1.12%, Samsung Internet 0.70% 98.25% StatCounter 일본 미국 Chrome 51.55%, Safari 29.83%, Edge 7.14%, Firefox 6.78%, Samsung Internet 1.69%, Brave 1.10% 98.09% StatCounter 미국 전 세계 Chrome 68.25%, Safari 16.48%, Edge 5.34%, Firefox 3.34%, Samsung Internet 2.06%, Opera 1.88% 97.35% StatCounter 전 세계 이 점유율은 브라우저 제품군의 비중이며 Chrome 111 이상 또는 Safari 16.4 이상 사용자의 정확한 비율이 아닙니다. 공개된 일부 상위 버전만 합산해 최소 버전 지원률로 표현하지 않습니다. 한국은 Safari, Samsung Internet과 Whale을 함께 확인합니다. 일본과 미국은 Safari 비중이 높으므로 Apple 기기의 Safari 검증을 Chromium 검증으로 대체하지 않습니다. 중국은 360 Safe, UC와 QQ의 최신 안정 버전을 별도로 확인합니다.",
    "url": "./../browser_support_guide/index.html#section-5"
  },
  {
    "document": "반응형 웹 브라우저 지원 가이드",
    ...
    "url": "./../browser_support_guide/index.html#section-7"
  },
  {
    "document": "반응형 웹 브라우저 지원 가이드",
    "section": "최소 지원 버전",
    "excerpt": "PC 운영체제 브라우저 최소 버전 적용 기준 Windows Chrome 111 이상 Tailwind CSS v4의 Chromium 하한 Windows Edge 111 이상 Chromium 111 계열 이상 Windows Firefox 128 이상 Tailwind CSS v4의 Firefox 하한 macOS Safari 16.4 이상 Tailwind CSS v4의 WebKit 하한 macOS…",
    "content": "3. 최소 지원 버전 PC 운영체제 브라우저 최소 버전 적용 기준 Windows Chrome 111 이상 Tailwind CSS v4의 Chromium 하한 Windows Edge 111 이상 Chromium 111 계열 이상 Windows Firefox 128 이상 Tailwind CSS v4의 Firefox 하한 macOS Safari 16.4 이상 Tailwind CSS v4의 WebKit 하한 macOS Chrome 111 이상 Tailwind CSS v4의 Chromium 하한 macOS Edge 111 이상 Chromium 111 계열 이상 macOS Firefox 128 이상 Tailwind CSS v4의 Firefox 하한 Whale, 360 Safe, UC와 QQ 등은 제품 버전 대신 Chromium 111 이상 엔진을 탑재한 최신 안정 버전 을 호환 대상으로 둡니다. 제품 버전과 엔진 버전의 대응이 일정하지 않아 Chrome과 동일하다고 간주하지 않습니다. 태블릿 운영체제 브라우저 최소 버전 적용 기준 iPadOS Safari 16.4 이상 Safari 16.4와 iPadOS 16.4가 함께 제공됨 Android Chrome 111 이상 Tailwind CSS v4의 Chromium 하한 Android Samsung Internet 23 이상 Chromium 115 기반으로 Chromium 111 하한 충족 Android Edge 111 이상 Chromium 111 계열 이상 Android Firefox 128 이상 Tailwind CSS v4의 Firefox 하한 모바일 운영체제 브라우저 최소 버전 적용 기준 iOS Safari 16.4 이상 Tailwind CSS v4의 WebKit 하한 Android Chrome 111 이상 Tailwind CSS v4의 Chromium 하한 Android Samsung Internet 23 이상 Chromium 115 기반으로 Chromium 111 하한 충족 Android Edge 111 이상 Chromium 111 계열 이상 Android Firefox 128 이상 Tailwind CSS v4의 Firefox 하한 iOS와 iPadOS의 Chrome, Edge, Firefox 등은 브라우저 이름과 별개로 해당 OS의 WebKit 영향을 받습니다. iOS·iPadOS 16.4 이상에서 각 브라우저의 최신 안정 버전을 확인합니다. Samsung Internet 23의 엔진 정보는 Samsung Internet 개발팀 안내 와 Samsung Developer User-Agent 안내 를 참고합니다. Safari 16.4의 OS 관계는 Apple Safari 16.4 릴리스 노트 에서 확인합니다.",
    "url": "./../browser_support_guide/index.html#section-3"
  },
  {
    "document": "APP 개발 표준",
  ...
  },
  {
    ...
    "url": "./../app/app.html#section-5"
  },
  {
    "document": "APP 개발 표준",
    "section": "Project Structure",
    "excerpt": "웹사이트, Flutter 앱, 앱 내 WebView, 카드사 인앱 서비스와 백오피스 등 Front-end 프로젝트는 하나의 저장소에서 관리하는 모노레포(Monorepo) 구조로 구성할 예정입니다. 각 애플리케이션은 독립적으로 빌드·테스트·배포할 수 있도록 apps 아래에 분리합니다. Web 공통 UI와 개발 설정은 packages , 언어에 종속되지 않는 API·Bridge 규격은 contr…",
    "content": "13. Project Structure 웹사이트, Flutter 앱, 앱 내 WebView, 카드사 인앱 서비스와 백오피스 등 Front-end 프로젝트는 하나의 저장소에서 관리하는 모노레포(Monorepo) 구조로 구성할 예정입니다. 각 애플리케이션은 독립적으로 빌드·테스트·배포할 수 있도록 apps 아래에 분리합니다. Web 공통 UI와 개발 설정은 packages , 언어에 종속되지 않는 API·Bridge 규격은 contracts 에서 관리합니다. Monorepo 전체 구조 <repository-root>/ ├── apps/ │ ├── website/ # 대외 웹사이트 │ ├── mobile/ # Flutter Native 앱 │ ├── app-webview/ # 앱 내 Next.js WebView │ ├── card-inapp/ # 카드사 인앱 서비스 │ └── backoffice/ # 운영·관리자 백오피스 ├── packages/ │ ├── ui/ # Web 공통 디자인 시스템과 UI 컴포넌트 │ ├── api-client/ # Web API Client와 생성 Type │ ├── webview-bridge/ # WebView Bridge 호출 Adapter │ ├── config/ # Web TypeScript, Lint와 Style 공통 설정 │ ├── testing/ # Web 테스트 공통 설정과 도구 │ └── utils/ # Web 범용 유틸리티 ├── contracts/ │ ├── api/ # API Schema와 생성 기준 │ └── webview-bridge/ # 플랫폼 중립 Bridge 요청·응답 규격 ├── tooling/ # 저장소 운영 및 자동화 도구 └── README.md 코드 요약: 웹 프로젝트는 하나의 Workspace에서 의존성과 공통 작업을 관리하고, 변경된 범위에 따라 Lint·Test·Build를 수행합니다. Flutter는 같은 저장소에 두되 Dart 의존성, Lock File과 빌드 도구는 Flutter Toolchain 기준으로 별도 관리합니다. contracts 를 기준으로 TypeScript와 Dart Type을 각각 생성하거나 구현하고, 앱 내부에는 채널별 검증과 호출 Adapter만 둡니다. Workspace와 Task Runner 제품은 배포 플랫폼과 CI 환경을 확인한 뒤 확정합니다. TBD website , card-inapp 과 backoffice 는 현재 계획된 배포 단위입니다. 각 프로젝트의 Framework와 최종 분리 범위는 별도로 확정합니다. 카드사별 독립 배포가 필요하면 apps/card-inapp/<partner> 로 분리하고, 동일 애플리케이션에서 설정만 구분한다면 하나의 프로젝트로 유지합니다. TBD Flutter Native · apps/mobile lib/ # Flutter 애플리케이션 소스 Root ├── app/ # 앱 전역 조립과 실행 설정 │ ├── routing/ # GoRouter Route, Guard와 Redirect 정책 │ ├── theme/ # 색상, Typography와 Material Theme 정의 │ └── app.dart # ProviderScope, Theme, Router를 조립하는 Root Widget ├── core/ # 특정 기능에 종속되지 않는 공통 기반 계층 │ ├── auth/ # 인증 상태, 로그인·로그아웃 조정과 사용자 전환 처리 │ ├── network/ # Dio Client, Interceptor, Timeout과 공통 오류 변환 │ ├── security/ # Origin 허용 목록, 입력 검증, 로그 Redaction 등 보안 정책 │ ├── storage/ # 승인된 로컬 저장소 Adapter와 사용자 데이터 정리 │ └── webview/ # WebView Controller, Navigation 정책과 Bridge Adapter ├── features/ # 업무 기능별로 분리한 Feature Module 모음 │ └── <feature>/ # 라운지, 예약 등 개별 업무 기능 단위 │ ├── data/ # Repository 구현, DTO와 Remote·Local DataSource │ ├── domain/ # Entity, UseCase, Repository Interface와 업무 규칙 │ └── presentation/ # 화면, ViewModel, Riverpod Provider와 UI State └── main.dart # 앱 진입점과 실행 전 필수 초기화 코드 요약: main.dart 는 앱 실행과 필수 초기화만 담당하고, app/app.dart 에서 ProviderScope , Theme과 Router를 조립합니다. core/network 와 core/webview 에는 공통 계약을 기준으로 생성하거나 구현한 Dart Adapter를 배치합니다. Next.js WebView · apps/app-webview src/ # Next.js WebView 애플리케이션 소스 Root ├── app/ # App Router의 Route, Layout과 전역 Provider 구성 │ ├── <route>/ # URL별 Page, Loading, Error 등 Route Segment │ ├── globals.css # Tailwind CSS 진입점과 최소 전역 스타일 │ ├── layout.tsx # 공통 문서 구조와 Root Layout │ └── providers.tsx # TanStack Query 등 Client Provider 조립 ├── components/ # 여러 Route와 Feature에서 재사용하는 UI │ ├── common/ # WebView 공통 Layout과 조합형 컴포넌트 │ └── ui/ # packages/ui를 조합한 WebView 전용 UI 컴포넌트 ├── features/ # 예약, 라운지 등 업무 기능별 Module 모음 │ └── <feature>/ # 하나의 사용자 업무 흐름을 구성하는 기능 단위 │ ├── api/ # 기능별 Query, Mutation과 API 호출 정의 │ ├── components/ # 해당 Feature 내부에서만 사용하는 UI │ ├── forms/ # Form Schema, Validation과 입력 변환 │ ├── hooks/ # 기능별 TanStack Query 및 상태 연동 Hook │ └── types/ # 기능 전용 Type과 View Model 정의 ├── lib/ # Framework·서비스 연동을 위한 공통 Adapter │ ├── api/ # 공통 API Client의 환경·인증·오류 정책 연결 │ ├── bridge/ # Native Bridge 요청·응답 검증과 호출 Adapter │ └── utils/ # 기능에 종속되지 않는 순수 Utility 함수 └── stores/ # Zustand 기반 전역 UI·클라이언트 상태 코드 요약: Next.js App Router는 app/ 에서 관리하고 Tailwind CSS 4의 전역 진입점은 app/globals.css 에 둡니다. components/ui 에는 packages/ui 를 조합한 WebView 전용 컴포넌트를 둡니다. lib/api 는 packages/api-client 를 환경·인증 정책과 연결하고, features/*/api 와 hooks 에는 기능별 TanStack Query 연동을 배치합니다. stores 에는 Zustand 상태를 둡니다. 앱 내부 구성 기준 영역 Directory 설명 Flutter apps/mobile/lib/app 앱 Root Widget, GoRouter, Theme과 Riverpod Root Scope 조립 Flutter apps/mobile/lib/core 인증, Network, 보안 저장소, 로깅과 공통 계약 기반 WebView·Bridge Adapter Flutter apps/mobile/lib/features/*/presentation UI, ViewModel, Riverpod Provider와 화면 상태 Flutter apps/mobile/lib/features/*/domain Entity, UseCase, Repository Interface와 업무 규칙 Flutter apps/mobile/lib/features/*/data Repository 구현, DTO·Model, Remote·Local DataSource WebView apps/app-webview/src/app Next.js Route, Layout, Provider와 Tailwind 전역 스타일 WebView apps/app-webview/src/components packages/ui 조합과 WebView 전용 UI 컴포넌트 WebView apps/app-webview/src/features 서비스 기능별 UI, React Hook Form, API, TanStack Query Hook과 Type WebView apps/app-webview/src/lib/bridge 공통 Bridge 계약을 사용하는 WebView 전용 검증과 호출 Adapter WebView apps/app-webview/src/stores Zustand 기반 전역 UI·클라이언트 상태 모노레포 운영 및 배포 기준 각 애플리케이션은 배포 Pipeline, 환경 변수, Version과 Rollback 단위를 분리하며 모노레포 전체를 항상 함께 배포하지 않습니다. 변경된 애플리케이션과 해당 애플리케이션이 사용하는 공통 패키지만 빌드·테스트하되, 공통 패키지 변경 시 모든 영향 범위의 회귀 테스트를 수행합니다. API Endpoint, 인증 Client, WebView Origin Allowlist와 배포 Secret은 서비스·제휴사·환경별로 분리하고 저장소에 포함하지 않습니다. 배포 시점이 다른 Native 앱과 WebView가 함께 동작할 수 있도록 Bridge와 API 계약은 하위 호환성을 유지하고, Breaking Change는 Version을 올려 단계적으로 전환합니다. 카드사 인앱과 백오피스의 인증·권한·보안 정책은 각 채널에서 구현하며, 공통화가 검증된 UI·Type·Utility만 공유 패키지로 이동합니다. APP 개발 표준",
    "url": "./../app/app.html#section-13"
  },
  {
    "document": "APP 개발 표준",
    "section": "Security",
  ...
  },
  {
    ...
    "url": "./../app/webView/webView_guide.html#section-9"
  },
  {
    "document": "Flutter WebView 설정 가이드",
    "section": "디버깅과 호환성 검증",
    "excerpt": "디버깅 Android는 Chrome DevTools의 원격 디버깅, iOS는 Safari Web Inspector로 WebView 콘텐츠를 확인합니다. WebView 디버깅 기능은 개발 빌드에서만 활성화하고 운영 빌드에서는 비활성화합니다. 플랫폼 검증 환경 플랫폼 필수 검증 환경 주요 확인 항목 Android 주요 국가의 Android SDK 24 이상에서 System WebView 111·…",
    "content": "12. 디버깅과 호환성 검증 디버깅 Android는 Chrome DevTools의 원격 디버깅, iOS는 Safari Web Inspector로 WebView 콘텐츠를 확인합니다. WebView 디버깅 기능은 개발 빌드에서만 활성화하고 운영 빌드에서는 비활성화합니다. 플랫폼 검증 환경 플랫폼 필수 검증 환경 주요 확인 항목 Android 주요 국가의 Android SDK 24 이상에서 System WebView 111·최신 버전 화면 복귀, 키보드, 권한, 파일 선택, Tailwind 렌더링과 엔진 업데이트 차이 iOS 최소·최신 iOS의 WKWebView 화면 복귀, 키보드, 권한, 파일 선택과 WebKit 차이 공통 검증 항목 페이지 로딩, 재시도와 네트워크 단절·지연 로그인, 로그아웃, 쿠키와 세션 유지 JavaScript Bridge와 허용되지 않은 요청 차단 외부 URL, Custom Scheme와 뒤로 가기 HTTP·SSL 오류와 사용자 안내 Safe Area, 화면 회전, 접근성 글자 크기와 다크 모드 메모리 사용량과 화면 종료 후 리소스 해제 한국·중국·일본·미국의 주요 단말과 중국 제조사별 WebView 차이 선택한 최신 Tailwind Utility의 기능 저하와 대체 표현",
    "url": "./../app/webView/webView_guide.html#section-12"
  },
  {
    "document": "Flutter WebView 설정 가이드",
    "section": "문서 목적과 적용 범위",
    ...
    "url": "./../app/webView/webView_guide.html#section-1"
  },
  {
    "document": "Flutter WebView 설정 가이드",
    "section": "세션, 오류와 보안",
    ...
    "url": "./../app/webView/webView_guide.html#section-11"
  },
  {
    "document": "Flutter WebView 설정 가이드",
    "section": "우선 결정 항목",
    ...
    "url": "./../app/webView/webView_guide.html#section-13"
  },
  {
    "document": "Flutter WebView 설정 가이드",
    ...
    "content": "3. 지원 환경과 WebView 엔진 webview_flutter 는 Chrome 또는 Safari 앱을 직접 실행하지 않고 운영체제가 제공하는 WebView 엔진을 Flutter 화면 안에 표시합니다. 구분 최소 지원 환경 사용 엔진 적용 기준 Flutter 프로젝트 승인 버전 해당 없음 SDK 버전과 지원 플랫폼 범위를 함께 고정 Dart 3.10 이상 해당 없음 webview_flutter 4.14.1 요구사항 Android Android SDK 24 이상, System WebView 111 이상 Android System WebView 앱 실행과 Tailwind CSS v4 렌더링 조건을 함께 검증 iOS iOS 16.4 이상 WKWebView Tailwind CSS v4의 Safari 16.4 이상 요구사항을 적용 플러그인 최소 조건과 프로젝트 기준 webview_flutter 4.14.1 의 패키지 문서에는 iOS 13 이상으로 표시되어 있고 최신 Flutter SDK의 공식 지원 범위는 iOS 15 이상입니다. 이 프로젝트는 Tailwind CSS v4의 Safari 16.4 이상 요구사항까지 충족하기 위해 iOS 16.4를 최소 지원 버전으로 설정합니다. 더 낮은 iOS를 지원해야 하는 기존 프로젝트는 Flutter, WebView와 Tailwind 버전을 함께 재검토합니다. Flutter SDK가 현재 지원하는 운영체제 범위는 Flutter 공식 지원 플랫폼 문서 를 기준으로 확인합니다. 프로젝트 설정값 설정 항목 적용값 설정 위치 확인 사항 Android minSdk 24 이상 android/app/build.gradle.kts 기존 값이 더 높으면 유지 iOS Deployment Target 16.4 이상 Xcode Runner Target Podfile 설정과 동일하게 유지 iOS Platform 16.4 이상 ios/Podfile Xcode Deployment Target과 동일하게 유지 WebView 패키지 4.14.1 pubspec.yaml pubspec.lock 에서 실제 선택 버전 확인",
    "url": "./../app/webView/webView_guide.html#section-3"
  },
  {
    "document": "Flutter WebView 설정 가이드",
    ...
    "url": "./../app/webView/webView_guide.html#section-2"
  },
  {
    "document": "Flutter WebView 설정 가이드",
    "section": "패키지 설치",
    ...
    "url": "./../app/webView/webView_guide.html#section-6"
  },
  {
    "document": "Flutter WebView 설정 가이드",
    "section": "Android 설정",
    "excerpt": "최소 SDK Android의 minSdk 를 24 이상으로 설정합니다. android { defaultConfig { minSdk = 24 } } Android System WebView 버전 minSdk 는 Android 앱의 실행 가능 버전만 결정하며 System WebView 버전을 보장하지 않습니다. Tailwind CSS v4 화면을 표시하려면 단말의 Android System We…",
    "content": "7. Android 설정 최소 SDK Android의 minSdk 를 24 이상으로 설정합니다. android { defaultConfig { minSdk = 24 } } Android System WebView 버전 minSdk 는 Android 앱의 실행 가능 버전만 결정하며 System WebView 버전을 보장하지 않습니다. Tailwind CSS v4 화면을 표시하려면 단말의 Android System WebView가 Chromium 111 계열 이상인지 확인하고, 기준보다 낮으면 사용자에게 업데이트가 필요함을 안내합니다. 실제 WebView 제공 패키지와 버전은 AndroidX WebKit의 WebViewCompat.getCurrentWebViewPackage() 로 확인할 수 있습니다. 자세한 방법은 Android WebView Version API 문서 를 참고합니다. 인터넷 권한 외부 웹 페이지를 표시하려면 인터넷 권한을 선언합니다. < uses-permission android:name = \"android.permission.INTERNET\" /> HTTP 통신 WebView 콘텐츠는 HTTPS를 사용합니다. 개발 환경에서 HTTP가 불가피한 경우에도 전체 통신을 허용하지 않고 Network Security Configuration으로 필요한 개발 도메인만 제한적으로 허용합니다.",
    "url": "./../app/webView/webView_guide.html#section-7"
  },
  {
    "document": "Flutter WebView 설정 가이드",
    "section": "Chrome과 Safari 호환성 기준",
    "excerpt": "플랫폼 피해야 할 표기 권장 표기 Android Chrome 특정 버전 이상 지원 Android SDK 24 이상과 System WebView 111 이상 지원 iOS Safari 특정 버전 이상 지원 iOS 16.4 이상에서 제공되는 WKWebView 지원 공통 최신 브라우저 지원 지원 OS와 WebView 엔진에서 프로젝트 사용 기능을 검증 Android System WebView는 Ch…",
    "content": "4. Chrome과 Safari 호환성 기준 플랫폼 피해야 할 표기 권장 표기 Android Chrome 특정 버전 이상 지원 Android SDK 24 이상과 System WebView 111 이상 지원 iOS Safari 특정 버전 이상 지원 iOS 16.4 이상에서 제공되는 WKWebView 지원 공통 최신 브라우저 지원 지원 OS와 WebView 엔진에서 프로젝트 사용 기능을 검증 Android System WebView는 Chromium 기반이지만 Chrome 앱과 업데이트 상태가 다를 수 있습니다. WKWebView와 Safari도 WebKit을 공유하지만 실행 환경과 제공 기능이 완전히 같지는 않습니다. JavaScript, CSS 또는 Web API의 지원 여부가 중요하면 최소·최신 지원 OS의 실제 WebView에서 기능 단위로 검증합니다.",
    "url": "./../app/webView/webView_guide.html#section-4"
  },
  {
    "document": "Flutter WebView 설정 가이드",
    "section": "iOS 설정",
    "excerpt": "Deployment Target Xcode의 Runner Target과 ios/Podfile 을 모두 iOS 16.4 이상으로 설정합니다. platform :ios , '16.4' App Transport Security HTTPS 사용을 원칙으로 합니다. HTTP 연결이 필요해도 NSAllowsArbitraryLoads 로 모든 연결을 허용하지 않고 필요한 개발 도메인만 예외로 등록합니다.…",
    "content": "8. iOS 설정 Deployment Target Xcode의 Runner Target과 ios/Podfile 을 모두 iOS 16.4 이상으로 설정합니다. platform :ios , '16.4' App Transport Security HTTPS 사용을 원칙으로 합니다. HTTP 연결이 필요해도 NSAllowsArbitraryLoads 로 모든 연결을 허용하지 않고 필요한 개발 도메인만 예외로 등록합니다. 카메라, 마이크 또는 위치정보를 사용하는 경우에는 실제 사용하는 기능에 해당하는 목적 문구를 Info.plist 에 등록합니다.",
    "url": "./../app/webView/webView_guide.html#section-8"
  },
  {
    "document": "Flutter WebView 설정 가이드",
    "section": "Tailwind CSS v4 호환성",
    "excerpt": "WebView에서 표시하는 웹 서비스는 Tailwind CSS v4를 사용합니다. Tailwind CSS v4는 최신 CSS 기능을 핵심 기능으로 사용하므로 Flutter 앱의 최소 실행 환경과 웹 화면의 최소 호환 환경을 구분합니다. 구분 최소 환경 적용 방법 Flutter 앱 실행 Android SDK 24 이상, System WebView 111 이상 앱 실행과 Tailwind CSS…",
    "content": "5. Tailwind CSS v4 호환성 WebView에서 표시하는 웹 서비스는 Tailwind CSS v4를 사용합니다. Tailwind CSS v4는 최신 CSS 기능을 핵심 기능으로 사용하므로 Flutter 앱의 최소 실행 환경과 웹 화면의 최소 호환 환경을 구분합니다. 구분 최소 환경 적용 방법 Flutter 앱 실행 Android SDK 24 이상, System WebView 111 이상 앱 실행과 Tailwind CSS v4 렌더링의 프로젝트 최소 기준 Flutter 앱 실행 iOS 16.4 이상 Tailwind CSS v4의 Safari 16.4 이상 요구사항 적용 Tailwind CSS v4 Chrome 111 이상 Android는 Chromium 111 계열 이상의 System WebView에서 검증 Tailwind CSS v4 Safari 16.4 이상 iOS WebView 서비스는 iOS 16.4 이상의 WKWebView에서 검증 이 프로젝트는 App과 WebView 화면의 지원 범위를 분리하지 않고 Tailwind CSS v4 호환성에 맞춥니다. 따라서 iOS 16.4 이상과 Android System WebView 111 이상을 프로젝트의 최소 지원 기준으로 적용합니다. Android WebView 검증 기준 Tailwind 공식 문서는 Android System WebView 버전을 직접 명시하지 않고 Chrome 111 이상을 요구합니다. Android System WebView가 Chromium 기반인 점을 고려하여 Chromium 111 계열 이상을 프로젝트 검증 기준으로 사용합니다. 이는 프로젝트의 호환성 판단이며 Tailwind가 Android System WebView 111을 별도로 보증한다는 의미는 아닙니다. 최신 CSS 기능 사용 Tailwind CSS v4의 기본 호환 범위를 충족하더라도 개별 Utility가 사용하는 최신 CSS 기능은 지원 시점이 다를 수 있습니다. 프로젝트에서 사용하는 Utility와 Web API를 최소 지원 Android System WebView와 iOS WKWebView에서 실제로 검증합니다. field-sizing: content , @starting-style , text-wrap: balance 처럼 기본 호환 범위보다 최신인 기능은 서비스에 필수적이지 않으면 사용하지 않습니다. 필요한 경우 주요 서비스 국가의 최소 WebView에서 검증하고, 지원하지 않는 환경에서도 핵심 정보와 기능을 사용할 수 있는 대체 표현을 제공합니다. 이러한 선택 기능을 사용하기 위해 최소 OS를 자동으로 높이지 않습니다. 다만 선택 Utility를 제외해도 Tailwind CSS v4 핵심 기능의 최소 요구사항인 Chrome·Chromium 111 이상과 Safari·WKWebView 16.4 이상은 유지합니다. 이보다 낮은 엔진을 반드시 지원해야 하면 Tailwind CSS v3.4 유지 또는 기술 스택 변경을 별도로 검토합니다. 주요 서비스 국가와 공개 점유율 주요 서비스 국가는 한국·중국·일본·미국이며 그 밖의 국가는 글로벌 통계로 보완합니다. 아래 수치는 2026년 7월 StatCounter 모바일 트래픽 기준입니다. 실제 설치 사용자 수가 아니므로 출시 전 판단의 보조 근거로만 사용합니다. 지역 Android iOS 근거 한국 65.39% 34.60% StatCounter 한국 중국 70.37% 29.51% StatCounter 중국 일본 36.41% 63.59% StatCounter 일본 미국 40.39% 59.58% StatCounter 미국 전 세계 68.36% 31.60% StatCounter 전 세계 최소 OS 기준의 도달 범위 2025년 12월 갱신된 Google Android 배포 원본 데이터에서 API 21은 0.1%, API 22는 0.3%, API 23은 0.4%입니다. 따라서 API 24 이상은 약 99.2%입니다. 이 수치는 Google의 Android 활성 기기 기준이며 Google Android 버전 배포 원본 데이터 를 근거로 계산합니다. 국가별 고객 비율이나 Android System WebView 111 이상의 비율을 의미하지 않습니다. 2026년 6월 7일 Apple 공식 집계에서 전체 iPhone의 79%가 iOS 26을 사용합니다. 따라서 최소한 79%는 iOS 16.4보다 높은 버전을 사용하지만, 이 값만으로 iOS 16.4 이상 전체 비율을 계산하지 않습니다. 집계 대상과 기준일은 Apple App Store 지원 페이지 에서 확인합니다. 국가별 버전 분포는 한국 Android , 중국 Android , 일본 Android , 미국 Android 와 한국 iOS , 중국 iOS , 일본 iOS , 미국 iOS 에서 확인합니다. 공개 페이지에 표시된 일부 상위 버전만 합산해 전체 지원률처럼 사용하지 않습니다. 중국 Android 검증 중국은 Android 비중이 70.37%이지만 Google Play 기반 WebView 업데이트를 모든 기기의 공통 조건으로 가정하지 않습니다. 제조사·OS·WebView 제공 패키지 조합에 따라 엔진과 업데이트 경로가 다를 수 있으므로 중국 대상 주요 제조사의 실제 기기에서 WebView 패키지와 버전, Tailwind CSS v4 핵심 화면을 검증합니다. 버전 문자열만으로 판단하기 어려운 환경에서는 프로젝트가 실제 사용하는 CSS 기능을 기능 단위로 확인합니다. 기능 검사에 통과하지 못한 기기는 업데이트 또는 지원 환경 안내 대상이며, 구체적인 진입 제한 정책은 App·기획·QA 담당자가 합의합니다. 근거 갱신과 승인 출시 전에는 공개 통계와 주요 국가의 실제 기기 검증 결과를 함께 사용합니다. 출시 후에는 국가·OS·WebView 엔진별 활성 사용자와 오류율을 우선 근거로 사용합니다. 핵심 국가별 허용할 미지원 사용자 비율과 재검토 주기는 프로젝트 담당자가 확정합니다. 점유율 수치에는 출처와 기준 월을 남기고 검토 시 최신 자료로 갱신합니다. 공식 문서 Tailwind CSS 공식 호환성 문서 : v4의 최소 브라우저 버전과 최신 CSS 기능 사용 기준 Tailwind CSS v4 공식 업그레이드 가이드 : v4 브라우저 요구사항과 구형 브라우저 지원 시 v3.4 유지 안내 Android 공식 WebView 관리 문서 : Android WebView 버전과 패키지 확인 방법 Apple WKWebView 공식 문서 : iOS 앱 내부 웹 콘텐츠 표시 API",
    "url": "./../app/webView/webView_guide.html#section-5"
  },
  {
    "document": "Flutter WebView 설정 가이드",
    ...
    "url": "./../app/webView/webView_guide.html#section-10"
  },
  {
    ...
    "url": "./../frontend_guide/index.html#section-1"
  },
  {
    "document": "Front-End 개발 가이드",
    "section": "미확정 항목 목록",
    ...
    "url": "./../frontend_guide/index.html#section-13"
  },
  {
    "document": "Front-End 개발 가이드",
    "section": "상태 및 데이터 관리",
    ...
    "url": "./../frontend_guide/index.html#section-7"
  },
  {
    "document": "Front-End 개발 가이드",
  ...
  },
  {
    ...
    "url": "./../frontend_guide/index.html#section-9"
  },
  {
    "document": "Front-End 개발 가이드",
    "section": "접근성 기본",
    ...
    "url": "./../frontend_guide/index.html#section-10"
  },
  {
    "document": "Front-End 개발 가이드",
    ...
    "url": "./../frontend_guide/index.html#section-12"
  },
  {
    "document": "Front-End 개발 가이드",
    "section": "테스트 및 품질 관리",
    ...
    "content": "11. 테스트 및 품질 관리 테스트는 파일 수나 커버리지 수치를 채우기 위해 작성하지 않습니다. 오류가 발생했을 때 사용자·금액·권한·데이터에 미치는 위험과 변경 빈도를 기준으로 우선순위를 정합니다. 11.1 Lint와 Test의 역할 Lint는 코드를 실행하지 않고 잘못된 작성 패턴을 찾으며, Test는 코드를 실행해 실제 결과가 의도대로 나오는지 확인합니다. 두 검사는 서로 대체하지 않습니다. 구분 Lint Test 확인 대상 코드 작성 방식과 정적으로 판단할 수 있는 오류 기능을 실행했을 때 나타나는 동작과 결과 코드 실행 실행하지 않음 실행함 대표 확인 항목 Hook 사용, ARIA 속성, label 연결과 키보드 지원 화면 표시, 사용자 입력, 상태 변경과 오류 처리 기본 명령 npm run lint 현재 미설치 · 후보 명령 npm run test 예를 들어 Lint는 클릭 요소에 필요한 키보드 지원이 빠진 코드를 찾을 수 있지만, 클릭 후 예약이 실제로 완료되는지는 판단할 수 없습니다. 해당 동작은 Test에서 사용자 입력과 화면 결과를 실행해 확인합니다. 반대로 Test를 작성하지 않은 코드까지 자동으로 검사하지는 않으므로 Lint도 함께 실행해야 합니다. 기본 검증 순서는 TypeScript 검사 → Lint → Test 이며, 병합 또는 통합 영향이 있는 변경에서는 production build를 추가로 확인합니다. 세부 기준은 Front-End Lint 가이드 와 Front-End 테스트 가이드 를 따릅니다. 11.2 우선 테스트 대상 금액 계산, 이용 조건, 유효기간처럼 오류 영향이 큰 순수 로직 일반 사용자와 직원의 권한 분기 결제·예약·이용권 사용의 중복 실행 방지 Bridge의 핵심 요청·응답 변환과 미지원 환경 처리 폼의 중요한 검증과 제출 흐름 여러 기능에서 반복 사용되는 공통 UI의 주요 동작 IA와 흐름이 확정된 뒤의 핵심 사용자 E2E 시나리오 11.3 강제 대상이 아닌 것 단순 표시 컴포넌트마다 작성하는 형식적인 테스트 Tailwind 클래스 문자열과 내부 구현 세부사항 모든 hook, variant, adapter에 대한 일괄 테스트 라이브러리 자체 동작을 다시 검증하는 테스트 근거 없이 정한 커버리지 백분율 11.4 기본 품질 기준 병합 전 프로젝트가 정한 TypeScript 검사, lint와 production build를 통과합니다. 기능 변경 시 영향 범위와 주요 실패 경로를 확인합니다. 공통 계약이나 패키지 변경 시 이를 사용하는 모든 애플리케이션의 회귀 테스트를 수행합니다. 결제·예약·이용권·권한·Bridge처럼 위험도가 높은 변경에는 해당 위험을 검증하는 테스트 또는 명시적인 검수 기록이 있어야 합니다. AI 생성 코드도 사람이 작성한 코드와 같은 리뷰와 검증 기준을 적용합니다. Storybook은 공통·재사용 UI 컴포넌트의 독립 렌더링, 공개 API와 주요 상태 확인에 사용합니다. Story 작성 대상과 반자동 운영 기준은 Storybook 운영 가이드 를 따릅니다. 도구 후보는 단위·컴포넌트 테스트에 Vitest와 React Testing Library, E2E에 Playwright입니다. API Mock은 기획과 Backend 계약이 확정된 뒤 사용할 수 있는 실제 환경에서 필요한 상태를 재현하기 어렵다면 Front-end 책임자 또는 프로젝트 담당자와 테스트 범위와 관리 책임을 정한 뒤 검토합니다. Mock 도구 도입 판단은 API Mock 도입 판단 기준 을 확인합니다. Swagger 또는 OpenAPI 제공을 미리 가정하거나 Front-end가 endpoint와 fixture를 먼저 만들지 않습니다. TBD 테스트 도구의 최종 조합, E2E 실행 환경, API mocking 방식, 커버리지 기준, formatter, pre-commit 검사와 CI 품질 게이트는 개발·배포 환경 확정 후 결정합니다.",
    "url": "./../frontend_guide/index.html#section-11"
  },
  {
    "document": "Front-End 개발 가이드",
    "section": "프로젝트 및 파일 구조",
    "excerpt": "웹사이트, Flutter 앱, 앱 내 WebView, 카드사 인앱 서비스와 백오피스 등 Front-end 프로젝트는 하나의 저장소에서 관리하는 모노레포를 사용합니다. 배포 가능한 애플리케이션은 apps , Web 공통 코드는 packages , 언어에 종속되지 않는 API·Bridge 규격은 contracts 에서 관리합니다. 이 문서에서 Front-end 또는 Web은 주로 apps/app…",
    "content": "4. 프로젝트 및 파일 구조 웹사이트, Flutter 앱, 앱 내 WebView, 카드사 인앱 서비스와 백오피스 등 Front-end 프로젝트는 하나의 저장소에서 관리하는 모노레포를 사용합니다. 배포 가능한 애플리케이션은 apps , Web 공통 코드는 packages , 언어에 종속되지 않는 API·Bridge 규격은 contracts 에서 관리합니다. 이 문서에서 Front-end 또는 Web은 주로 apps/app-webview 구현 영역을 의미합니다. 전체 저장소 구조와 운영 원칙은 Front-End Monorepo 공통 기준 을 단일 기준으로 사용합니다. 이 절은 apps/app-webview 의 상세 배치 기준을 보완하며, 내용이 충돌하면 공통 기준을 우선합니다. 4.1 배치 원칙 라우트, 레이아웃 및 Next.js 예약 파일은 apps/app-webview/src/app 에서 관리합니다. 특정 기능에서만 쓰는 UI, API 연동, 폼, 훅과 타입은 해당 기능 가까이에 둡니다. 둘 이상의 Web 애플리케이션에서 실제로 공유하는 UI 원형은 packages/ui , WebView 전용 조합과 Wrapper는 apps/app-webview/src/components/ui 에서 관리합니다. 비슷해 보인다는 이유만으로 코드를 공통 영역이나 공통 패키지로 이동하지 않습니다. 사용하지 않는 빈 폴더, store, hook, wrapper 또는 패키지를 미리 만들지 않습니다. 아래 트리는 현재 목표로 하는 논리 구조입니다. 실제 사용처가 없는 빈 공통 패키지를 미리 만들지 않으며, Workspace 도구와 Task Runner는 CI 및 배포 환경을 확인한 뒤 확정합니다. TBD <repository-root>/ ├── apps/ │ ├── website/ # 대외 웹사이트 │ ├── mobile/ # Flutter Native 앱 │ ├── app-webview/ # Front-end · 앱 내 Next.js WebView │ │ └── src/ │ │ ├── app/ # Routes, Layouts, Providers │ │ ├── components/ # WebView 전용 UI 조합 │ │ ├── features/ # 서비스 기능별 구현 │ │ └── lib/ # API·Bridge 등 앱 기반 코드 │ ├── card-inapp/ # 카드사 인앱 서비스 │ └── backoffice/ # 운영·관리자 백오피스 ├── packages/ │ ├── ui/ # 검증된 Web 공통 UI │ ├── api-client/ # Web API Client와 생성 Type │ ├── webview-bridge/ # WebView Bridge 호출 Adapter │ ├── config/ # Web 공통 개발 설정 │ ├── testing/ # Web 공통 테스트 설정 │ └── utils/ # Web 범용 유틸리티 ├── contracts/ │ ├── api/ # API Schema와 생성 기준 │ └── webview-bridge/ # 플랫폼 중립 Bridge 계약 ├── tooling/ # 저장소 운영 및 자동화 도구 └── README.md contracts 를 기준으로 TypeScript와 Dart Type을 각각 생성하거나 구현하고, packages 와 각 애플리케이션 내부에는 언어·채널별 Adapter를 둡니다. 카드사별 독립 배포가 필요하면 apps/card-inapp/<partner> 로 분리할 수 있습니다. TBD 하나의 기능이 커진 뒤에만 다음처럼 내부 책임을 나눌 수 있습니다. src/features/ticket/ ├── api/ ├── components/ ├── forms/ └── types.ts 4.2 컴포넌트와 파일 분리 단순한 컴포넌트는 한 파일로 시작합니다. 파일 길이 자체보다 책임의 분리 필요성, 변경 빈도, 재사용 범위를 기준으로 파일을 나눕니다. 타입, variant, hook 또는 테스트 파일은 실제 분리 이유가 있을 때만 만듭니다. 모든 컴포넌트에 동일한 폴더·파일 세트를 강제하지 않습니다. Button/ ├── Button.tsx ├── Button.types.ts # 외부 공개 타입이 커졌을 때 ├── Button.variants.ts # variant 조합이 복잡해졌을 때 └── Button.test.tsx # 위험도상 테스트가 필요할 때 4.3 공통화 판단 공통화는 코드 모양이 아니라 책임과 변경 이유를 기준으로 합니다. 다음 질문에 모두 답할 수 있을 때 공통화를 검토합니다. 둘 이상의 실제 사용처가 있는가? 사용처들의 의미와 변경 이유가 같은가? 공통화 후 API가 원래 구현보다 이해하기 쉬운가? 특정 기능의 예외를 props나 조건문으로 계속 추가하지 않아도 되는가? 4.4 모노레포 운영 기준 각 애플리케이션은 Pipeline, 환경 설정, Version과 Rollback 단위를 분리하며 모노레포 전체를 항상 함께 배포하지 않습니다. 변경 경로와 의존 관계를 기준으로 영향받는 애플리케이션과 패키지를 빌드·테스트합니다. 공통 계약이나 패키지 변경 시 모든 사용처의 회귀 테스트를 수행합니다. Web Workspace와 Flutter는 Toolchain별 Lock File과 빌드 도구를 각각 관리합니다. 환경 변수, 인증 Client, Origin Allowlist와 배포 Secret은 애플리케이션·제휴사·환경별로 분리합니다. 운영 배포는 <app-name>/v<version> 형식의 앱별 Tag와 Release Note로 Artifact를 식별합니다.",
    "url": "./../frontend_guide/index.html#section-4"
  },
  {
    "document": "Front-End 개발 가이드",
    ...
    "url": "./../frontend_guide/index.html#section-3"
  },
  {
    "document": "Front-End 개발 가이드",
    ...
    "url": "./../frontend_guide/index.html#section-5"
  },
  {
    "document": "Front-End 개발 가이드",
    ...
    "url": "./../frontend_guide/index.html#section-6"
  },
  {
    "document": "Front-End 개발 가이드",
    ...
    "url": "./../frontend_guide/index.html#section-8"
  },
  {
    ...
    "url": "./../performance_guide/index.html#section-16"
  },
  {
    "document": "Front-End 네트워크 지연 대응 및 성능 검증 가이드",
    ...
    "url": "./../performance_guide/index.html#section-6"
  },
  {
    "document": "Front-End 네트워크 지연 대응 및 성능 검증 가이드",
    "section": "로딩 UI 선택 기준",
    ...
    "url": "./../performance_guide/index.html#section-5"
  },
  {
    "document": "Front-End 네트워크 지연 대응 및 성능 검증 가이드",
    "section": "리뷰 체크리스트",
    ...
    "url": "./../performance_guide/index.html#section-15"
  },
  {
    "document": "Front-End 네트워크 지연 대응 및 성능 검증 가이드",
    "section": "문서 목적",
    ...
    "url": "./../performance_guide/index.html#section-1"
  },
  {
    "document": "Front-End 네트워크 지연 대응 및 성능 검증 가이드",
    ...
    "url": "./../performance_guide/index.html#section-13"
  },
  {
    "document": "Front-End 네트워크 지연 대응 및 성능 검증 가이드",
    "section": "작업 및 검증 흐름",
    ...
    "url": "./../performance_guide/index.html#section-14"
  },
  {
    "document": "Front-End 네트워크 지연 대응 및 성능 검증 가이드",
    "section": "적용 범위와 책임",
    ...
    "url": "./../performance_guide/index.html#section-2"
  },
  {
    "document": "Front-End 네트워크 지연 대응 및 성능 검증 가이드",
    ...
    "url": "./../performance_guide/index.html#section-10"
  },
  {
    "document": "Front-End 네트워크 지연 대응 및 성능 검증 가이드",
    ...
    "url": "./../performance_guide/index.html#section-7"
  },
  {
    "document": "Front-End 네트워크 지연 대응 및 성능 검증 가이드",
    "section": "테스트 환경 구분",
    ...
    "url": "./../performance_guide/index.html#section-11"
  },
  {
    "document": "Front-End 네트워크 지연 대응 및 성능 검증 가이드",
    "section": "핵심 원칙",
    ...
    "url": "./../performance_guide/index.html#section-3"
  },
  {
    "document": "Front-End 네트워크 지연 대응 및 성능 검증 가이드",
    "section": "화면 상태 구분",
    ...
    "url": "./../performance_guide/index.html#section-4"
  },
  {
    "document": "Front-End 네트워크 지연 대응 및 성능 검증 가이드",
    ...
    "url": "./../performance_guide/index.html#section-12"
  },
  {
    "document": "Front-End 네트워크 지연 대응 및 성능 검증 가이드",
    ...
    "url": "./../performance_guide/index.html#section-9"
  },
  {
    "document": "Front-End 네트워크 지연 대응 및 성능 검증 가이드",
    ...
    "url": "./../performance_guide/index.html#section-8"
  },
  {
    ...
    "url": "./../i18n_guide/index.html#section-10"
  },
  {
    "document": "Front-End 다국어 및 로컬 LLM 번역 가이드",
    "section": "검증 기준",
    ...
    "url": "./../i18n_guide/index.html#section-11"
  },
  {
    "document": "Front-End 다국어 및 로컬 LLM 번역 가이드",
    ...
    "url": "./../i18n_guide/index.html#section-9"
  },
  {
    "document": "Front-End 다국어 및 로컬 LLM 번역 가이드",
    "section": "로컬 LLM 번역",
    ...
    "url": "./../i18n_guide/index.html#section-7"
  },
  {
    "document": "Front-End 다국어 및 로컬 LLM 번역 가이드",
    "section": "문서 목적",
    "excerpt": "이 문서는 apps/mobile 의 Flutter 앱이 호스팅하는 apps/app-webview 에서 개발자가 한국어 문구를 소스 코드에 작성하고, 추출된 메시지를 로컬 LLM으로 번역한 뒤, 실행 환경의 언어에 맞는 번역을 표시하는 기준을 정의합니다. 다국어 처리는 메시지 작성, 번역 생성과 실행 중 언어 선택을 분리합니다. 로컬 LLM은 개발 과정에서 번역 카탈로그를 만드는 데만 사용하고…",
    "content": "1. 문서 목적 이 문서는 apps/mobile 의 Flutter 앱이 호스팅하는 apps/app-webview 에서 개발자가 한국어 문구를 소스 코드에 작성하고, 추출된 메시지를 로컬 LLM으로 번역한 뒤, 실행 환경의 언어에 맞는 번역을 표시하는 기준을 정의합니다. 다국어 처리는 메시지 작성, 번역 생성과 실행 중 언어 선택을 분리합니다. 로컬 LLM은 개발 과정에서 번역 카탈로그를 만드는 데만 사용하고 사용자 요청을 처리하는 실행 경로에서는 호출하지 않습니다. Flutter 앱은 앱 언어 저장, 디바이스 locale 확인과 온디바이스 번역을 담당합니다. Next.js WebView는 Lingui 카탈로그 로드, 번역 UI와 원문 fallback을 담당하며 두 영역의 요청과 응답은 contracts/webview-bridge 계약으로 연결합니다. 전체 저장소 구조와 공통화 기준은 Front-End Monorepo 공통 기준 을 우선합니다. Next.js WebView의 구현 기준은 Front-End 개발 가이드 를 함께 따릅니다.",
    "url": "./../i18n_guide/index.html#section-1"
  },
  {
    "document": "Front-End 다국어 및 로컬 LLM 번역 가이드",
    "section": "실행 언어 결정",
    ...
    "url": "./../i18n_guide/index.html#section-8"
  },
  {
    "document": "Front-End 다국어 및 로컬 LLM 번역 가이드",
    "section": "완료 확인사항",
    ...
    "url": "./../i18n_guide/index.html#section-14"
  },
  {
    "document": "Front-End 다국어 및 로컬 LLM 번역 가이드",
    "section": "자동 생성 ID 원리",
    ...
    "url": "./../i18n_guide/index.html#section-5"
  },
  {
    "document": "Front-End 다국어 및 로컬 LLM 번역 가이드",
    ...
    "url": "./../i18n_guide/index.html#section-2"
  },
  {
    "document": "Front-End 다국어 및 로컬 LLM 번역 가이드",
    "section": "적용 전 결정 항목",
    ...
    "url": "./../i18n_guide/index.html#section-13"
  },
  {
    "document": "Front-End 다국어 및 로컬 LLM 번역 가이드",
    "section": "처리 흐름과 책임",
  ...
  },
  {
    ...
    "url": "./../i18n_guide/index.html#section-4"
  },
  {
    "document": "Front-End 다국어 및 로컬 LLM 번역 가이드",
    "section": "피해야 할 구현",
    ...
    "url": "./../i18n_guide/index.html#section-12"
  },
  {
    ...
    "url": "./../security_guide/index.html#section-9"
  },
  {
    "document": "Front-End 보안과 개인정보 가이드",
    ...
    "url": "./../security_guide/index.html#section-6"
  },
  {
    "document": "Front-End 보안과 개인정보 가이드",
    "section": "문서 목적과 적용 범위",
    "excerpt": "이 문서는 Lounge Front-end와 WebView 화면을 구현하고 검토할 때 적용할 보안·개인정보 기준 원본입니다. UI에서 값을 숨기는 수준이 아니라 외부 입력이 화면, 네트워크, 저장소, 로그와 Native Bridge를 통과하는 전체 흐름을 확인합니다. 구체적인 인증 제공자, Cookie 또는 token 방식, CSP 값, 허용 Origin, Redirect URI, 개인정보 분…",
    "content": "1. 문서 목적과 적용 범위 이 문서는 Lounge Front-end와 WebView 화면을 구현하고 검토할 때 적용할 보안·개인정보 기준 원본입니다. UI에서 값을 숨기는 수준이 아니라 외부 입력이 화면, 네트워크, 저장소, 로그와 Native Bridge를 통과하는 전체 흐름을 확인합니다. 구체적인 인증 제공자, Cookie 또는 token 방식, CSP 값, 허용 Origin, Redirect URI, 개인정보 분류와 보존 기간은 아직 확정하지 않습니다. 해당 결정은 Backend·App·배포·보안 담당 기준과 함께 확정합니다. 브라우저와 WebView의 코드는 사용자가 확인하고 변조할 수 있습니다. Client 검증은 사용자 경험과 조기 오류 발견을 위한 것이며 인증, 권한과 업무 규칙의 최종 통제를 대신하지 않습니다. 이 문서를 읽는 기준 “신뢰하지 않는다”는 해당 값을 사용하지 말라는 뜻이 아닙니다. 값이 저장하거나 전달한 당시와 같다고 단정하지 말고, 사용 목적과 위험도에 맞게 확인한다는 뜻입니다. 화면 테마나 접힘 상태처럼 영향이 작은 값은 허용 값과 기본값만 확인해도 됩니다. 권한, 금액, 사용자 식별자와 이동 URL처럼 영향이 큰 값은 형식뿐 아니라 허용 범위와 서버 계약도 확인합니다. “확인합니다”와 “검토합니다”는 모든 기능에 같은 보안 도구를 적용하라는 뜻이 아닙니다. 해당 기능에 실제로 존재하는 입력·저장·통신 경계만 확인합니다. Backend·Native App·배포 영역의 내용은 Front-end가 연동 전에 확인할 조건입니다. 현재 프로젝트에서 이미 구현됐다는 의미가 아니며 실제 방식과 제공 범위는 TBD 입니다.",
    "url": "./../security_guide/index.html#section-1"
  },
  {
    "document": "Front-End 보안과 개인정보 가이드",
    "section": "외부 입력과 XSS",
    ...
    "url": "./../security_guide/index.html#section-3"
  },
  {
    "document": "Front-End 보안과 개인정보 가이드",
    "section": "의존성과 공급망",
    ...
    "url": "./../security_guide/index.html#section-8"
  },
  {
    "document": "Front-End 보안과 개인정보 가이드",
    ...
    "url": "./../security_guide/index.html#section-7"
  },
  {
    "document": "Front-End 보안과 개인정보 가이드",
    "section": "인증, 권한과 세션",
  ...
  },
  {
    ...
    "url": "./../security_guide/index.html#section-11"
  },
  {
    "document": "Front-End 보안과 개인정보 가이드",
    "section": "책임과 신뢰 경계",
  ...
  },
  {
    ...
    "url": "./../security_guide/index.html#section-5"
  },
  {
    "document": "Front-End 보안과 개인정보 가이드",
    ...
    "url": "./../security_guide/index.html#section-10"
  },
  {
    ...
    "url": "./../test_guide/index.html#section-7"
  },
  {
    "document": "Front-End 테스트 가이드",
    "section": "리뷰 체크리스트",
    ...
    "url": "./../test_guide/index.html#section-9"
  },
  {
    "document": "Front-End 테스트 가이드",
    "section": "목적과 현재 상태",
    ...
    "url": "./../test_guide/index.html#section-1"
  },
  {
    "document": "Front-End 테스트 가이드",
    "section": "우선 테스트 대상",
    ...
    "url": "./../test_guide/index.html#section-3"
  },
  {
    "document": "Front-End 테스트 가이드",
    "section": "작성 기준",
    ...
    "url": "./../test_guide/index.html#section-6"
  },
  {
    "document": "Front-End 테스트 가이드",
    "section": "적용 원칙",
    ...
    "url": "./../test_guide/index.html#section-2"
  },
  {
    "document": "Front-End 테스트 가이드",
    "section": "테스트 수준 선택",
    ...
    "url": "./../test_guide/index.html#section-4"
  },
  {
    "document": "Front-End 테스트 가이드",
    "section": "CI와 완료 기준",
    ...
    "url": "./../test_guide/index.html#section-8"
  },
  {
    "document": "Front-End 테스트 가이드",
    ...
    "url": "./../test_guide/index.html#section-5"
  },
  {
    ...
    "url": "./../lint_guide/index.html#section-5"
  },
  {
    "document": "Front-End Lint 가이드",
    "section": "리뷰 체크리스트",
    ...
    "url": "./../lint_guide/index.html#section-8"
  },
  {
    "document": "Front-End Lint 가이드",
    "section": "목적과 범위",
    ...
    "url": "./../lint_guide/index.html#section-1"
  },
  {
    "document": "Front-End Lint 가이드",
    "section": "적용 범위와 예외",
    ...
    "url": "./../lint_guide/index.html#section-6"
  },
  {
    "document": "Front-End Lint 가이드",
    "section": "적용 원칙",
    ...
    "url": "./../lint_guide/index.html#section-2"
  },
  {
    "document": "Front-End Lint 가이드",
    "section": "접근성 규칙",
    ...
    "url": "./../lint_guide/index.html#section-3"
  },
  {
    "document": "Front-End Lint 가이드",
    "section": "참고 자료",
    ...
    "url": "./../lint_guide/index.html#section-9"
  },
  {
    "document": "Front-End Lint 가이드",
    "section": "CI 적용 기준",
    "excerpt": "CI 구성이 확정되면 typecheck 와 lint 를 PR 필수 검사 후보로 적용합니다. 새 규칙은 기존 오류 수와 실행 시간을 확인한 뒤 CI 차단 조건으로 전환합니다. warning 허용 여부와 모노레포 검사 범위는 CI 환경이 정해진 뒤 확정합니다. LLM이 생성한 코드도 같은 기준을 적용합니다. 모델의 설명을 검증 결과로 간주하지 않고 실제 명령 결과를 확인합니다.",
    "content": "7. CI 적용 기준 CI 구성이 확정되면 typecheck 와 lint 를 PR 필수 검사 후보로 적용합니다. 새 규칙은 기존 오류 수와 실행 시간을 확인한 뒤 CI 차단 조건으로 전환합니다. warning 허용 여부와 모노레포 검사 범위는 CI 환경이 정해진 뒤 확정합니다. LLM이 생성한 코드도 같은 기준을 적용합니다. 모델의 설명을 검증 결과로 간주하지 않고 실제 명령 결과를 확인합니다.",
    "url": "./../lint_guide/index.html#section-7"
  },
  {
    "document": "Front-End Lint 가이드",
    ...
    "url": "./../lint_guide/index.html#section-4"
  },
  {
    "document": "Front-End Monorepo 공통 기준",
    "section": "공통화와 계약 관리",
    "excerpt": "특정 기능이나 애플리케이션에서만 사용하는 코드는 해당 영역 가까이에 둡니다. 둘 이상의 실제 사용처가 있고 의미와 변경 이유가 같을 때만 packages 로 이동합니다. Web 공통 UI는 packages/ui , WebView 전용 조합과 Wrapper는 apps/app-webview/src/components 에서 관리합니다. API와 Bridge의 플랫폼 중립 원본은 contracts…",
    "content": "4. 공통화와 계약 관리 특정 기능이나 애플리케이션에서만 사용하는 코드는 해당 영역 가까이에 둡니다. 둘 이상의 실제 사용처가 있고 의미와 변경 이유가 같을 때만 packages 로 이동합니다. Web 공통 UI는 packages/ui , WebView 전용 조합과 Wrapper는 apps/app-webview/src/components 에서 관리합니다. API와 Bridge의 플랫폼 중립 원본은 contracts 에서 관리하고, TypeScript와 Dart Type 또는 Adapter는 각 Toolchain에서 별도로 생성하거나 구현합니다. 생성된 Type과 Client를 수동으로 서로 다르게 수정하지 않으며 계약 변경과 생성 결과를 하나의 변경으로 검증합니다. Native 앱과 WebView는 배포 시점이 다르므로 Bridge와 API 계약의 하위 호환성을 유지하고, Breaking Change는 Version을 올려 단계적으로 전환합니다.",
    "url": "./../monorepo/index.html#section-4"
  },
  {
    "document": "Front-End Monorepo 공통 기준",
    "section": "변경 기준과 미확정 항목",
    "excerpt": "구조 변경 기준 새 애플리케이션을 추가할 때 Owner, 배포 단위, 환경, 권한과 Rollback 책임을 함께 정의합니다. 새 공통 패키지를 추가할 때 실제 사용처, 공개 API, 의존 방향과 변경 책임을 확인합니다. 계약을 변경할 때 영향을 받는 TypeScript·Dart 생성 결과, Adapter와 출시된 앱 Version을 함께 검토합니다. 우선 결정 항목 실제 저장소 이름 Web…",
    "content": "8. 변경 기준과 미확정 항목 구조 변경 기준 새 애플리케이션을 추가할 때 Owner, 배포 단위, 환경, 권한과 Rollback 책임을 함께 정의합니다. 새 공통 패키지를 추가할 때 실제 사용처, 공개 API, 의존 방향과 변경 책임을 확인합니다. 계약을 변경할 때 영향을 받는 TypeScript·Dart 생성 결과, Adapter와 출시된 앱 Version을 함께 검토합니다. 우선 결정 항목 실제 저장소 이름 Web Workspace, 패키지 관리자와 Task Runner 제품 웹사이트, 카드사 인앱과 백오피스의 Framework 및 최종 분리 범위 카드사별 단일 프로젝트 또는 독립 프로젝트 구성 웹 애플리케이션별 배포 플랫폼과 CI/CD 품질 Gate Front-End Monorepo 공통 기준",
    "url": "./../monorepo/index.html#section-8"
  },
  {
    "document": "Front-End Monorepo 공통 기준",
    "section": "저장소 구조",
    "excerpt": "<repository-root>/ ├── apps/ │ ├── website/ # 대외 웹사이트 │ ├── mobile/ # Flutter Native 앱 │ ├── app-webview/ # Front-end · 앱 내 Next.js WebView │ ├── card-inapp/ # 카드사 인앱 서비스 │ └── backoffice/ # 운영·관리자 백오피스 ├── packages/ │ ├…",
    "content": "2. 저장소 구조 <repository-root>/ ├── apps/ │ ├── website/ # 대외 웹사이트 │ ├── mobile/ # Flutter Native 앱 │ ├── app-webview/ # Front-end · 앱 내 Next.js WebView │ ├── card-inapp/ # 카드사 인앱 서비스 │ └── backoffice/ # 운영·관리자 백오피스 ├── packages/ │ ├── ui/ # 검증된 Web 공통 UI │ ├── api-client/ # Web API Client와 생성 Type │ ├── webview-bridge/ # WebView Bridge 호출 Adapter │ ├── config/ # Web 공통 개발 설정 │ ├── testing/ # Web 공통 테스트 설정 │ └── utils/ # Web 범용 유틸리티 ├── contracts/ │ ├── api/ # API Schema와 생성 기준 │ └── webview-bridge/ # 플랫폼 중립 Bridge 요청·응답 규격 ├── tooling/ # 저장소 운영 및 자동화 도구 └── README.md 애플리케이션 범위 Directory 역할 기술·분리 상태 apps/website 대외 웹사이트 Framework 및 배포 단위 TBD apps/mobile Flutter Native 앱과 기기 기능 Flutter Toolchain apps/app-webview 앱 내 Front-end 서비스 화면과 업무 흐름 Next.js·React·TypeScript apps/card-inapp 카드사 인앱 서비스 제휴사별 분리 방식과 Framework TBD apps/backoffice 운영·관리자 업무 Framework 및 배포 단위 TBD 카드사마다 독립 배포와 인증·보안 정책이 필요하면 apps/card-inapp/<partner> 로 분리합니다. 동일 애플리케이션에서 설정만 구분할 수 있다면 하나의 프로젝트로 유지합니다. TBD",
    "url": "./../monorepo/index.html#section-2"
  },
  {
    "document": "Front-End Monorepo 공통 기준",
    "section": "적용 범위와 표기",
    "excerpt": "웹사이트, Flutter 앱, 앱 내 WebView, 카드사 인앱 서비스와 백오피스 등 Front-end 프로젝트를 하나의 저장소에서 관리합니다. 실제 저장소 이름은 아직 정하지 않았으므로 이 문서에서는 <repository-root> 로 표현합니다. 표시 의미 적용 방법 MUST 확정 원칙 구현, 검수와 배포에서 반드시 준수 TBD 결정 필요 담당자 합의와 승인 후 이 문서에 반영 EXAM…",
    "content": "1. 적용 범위와 표기 웹사이트, Flutter 앱, 앱 내 WebView, 카드사 인앱 서비스와 백오피스 등 Front-end 프로젝트를 하나의 저장소에서 관리합니다. 실제 저장소 이름은 아직 정하지 않았으므로 이 문서에서는 <repository-root> 로 표현합니다. 표시 의미 적용 방법 MUST 확정 원칙 구현, 검수와 배포에서 반드시 준수 TBD 결정 필요 담당자 합의와 승인 후 이 문서에 반영 EXAMPLE 참고 예시 프로젝트 조건에 맞게 변경 가능",
    "url": "./../monorepo/index.html#section-1"
  },
  {
    "document": "Front-End Monorepo 공통 기준",
    "section": "환경과 Secret",
    "excerpt": "dev · qa · prod 환경과 배포 권한은 애플리케이션별로 분리합니다. API Endpoint, 인증 Client, Host, Cookie 범위, CORS·CSP, Redirect URI와 Origin Allowlist는 서비스·제휴사·환경별 승인 값으로 관리합니다. 브라우저에 노출 가능한 공개 설정과 서버·CI에서만 사용하는 Secret을 구분합니다. Signing Key, Token…",
    "content": "7. 환경과 Secret dev · qa · prod 환경과 배포 권한은 애플리케이션별로 분리합니다. API Endpoint, 인증 Client, Host, Cookie 범위, CORS·CSP, Redirect URI와 Origin Allowlist는 서비스·제휴사·환경별 승인 값으로 관리합니다. 브라우저에 노출 가능한 공개 설정과 서버·CI에서만 사용하는 Secret을 구분합니다. Signing Key, Token과 배포 자격 증명은 저장소, 앱 Bundle, Web JavaScript와 Build Log에 포함하지 않습니다. MUST Client 공개 설정, 자격 증명, CSP·CORS와 공급망의 상세 검토 기준은 Front-End 보안과 개인정보 가이드 를 함께 확인합니다.",
    "url": "./../monorepo/index.html#section-7"
  },
  {
    "document": "Front-End Monorepo 공통 기준",
    "section": "CI/CD와 Release",
    "excerpt": "각 애플리케이션은 Pipeline, Artifact, 환경 설정, Version, 승인과 Rollback 단위를 분리하며 모노레포 전체를 항상 함께 배포하지 않습니다. 변경 경로와 의존 관계를 기준으로 영향받는 애플리케이션과 패키지의 Lint·Test·Build를 수행합니다. 공통 계약이나 패키지를 변경하면 이를 사용하는 모든 애플리케이션의 회귀 테스트를 수행합니다. 운영 배포는 <app-n…",
    "content": "6. CI/CD와 Release 각 애플리케이션은 Pipeline, Artifact, 환경 설정, Version, 승인과 Rollback 단위를 분리하며 모노레포 전체를 항상 함께 배포하지 않습니다. 변경 경로와 의존 관계를 기준으로 영향받는 애플리케이션과 패키지의 Lint·Test·Build를 수행합니다. 공통 계약이나 패키지를 변경하면 이를 사용하는 모든 애플리케이션의 회귀 테스트를 수행합니다. 운영 배포는 <app-name>/v<version> 형식의 앱별 Tag와 Release Note를 남기고 해당 Artifact와 연결합니다. Flutter 앱은 Codemagic 기준을 적용하고, 웹 애플리케이션의 배포 플랫폼과 품질 Gate는 인프라 환경을 확인한 뒤 확정합니다. TBD",
    "url": "./../monorepo/index.html#section-6"
  },
  {
    "document": "Front-End Monorepo 공통 기준",
    "section": "Directory 책임",
    "excerpt": "영역 책임 금지 사항 apps 독립적으로 빌드·테스트·배포 가능한 애플리케이션 다른 앱의 내부 소스 경로를 직접 Import하지 않음 packages 둘 이상의 Web 애플리케이션에서 검증된 공통 구현 예상되는 재사용만으로 빈 패키지나 Wrapper를 만들지 않음 contracts 언어에 종속되지 않는 API·Bridge Schema와 Version 계약 특정 앱의 화면 상태나 구현 세부사항…",
    "content": "3. Directory 책임 영역 책임 금지 사항 apps 독립적으로 빌드·테스트·배포 가능한 애플리케이션 다른 앱의 내부 소스 경로를 직접 Import하지 않음 packages 둘 이상의 Web 애플리케이션에서 검증된 공통 구현 예상되는 재사용만으로 빈 패키지나 Wrapper를 만들지 않음 contracts 언어에 종속되지 않는 API·Bridge Schema와 Version 계약 특정 앱의 화면 상태나 구현 세부사항을 포함하지 않음 tooling 저장소 전체에서 사용하는 자동화와 운영 도구 애플리케이션 업무 로직을 포함하지 않음",
    "url": "./../monorepo/index.html#section-3"
  },
  {
    "document": "Front-End Monorepo 공통 기준",
    ...
    "url": "./../monorepo/index.html#section-5"
  },
  {
  ...
  },
  {
    ...
    "url": "./../ui_guide/react_code_exports.html#section-1"
  },
  {
    "document": "React Code Exports 가이드",
    "section": "역할과 책임",
    ...
    "url": "./../ui_guide/react_code_exports.html#section-3"
  },
  {
    "document": "React Code Exports 가이드",
    "section": "완료 기준",
    "excerpt": "기존 컴포넌트와 디자인 토큰을 우선 사용했는가? 화면의 주요 구조와 상태가 Figma 의도와 일치하는가? 의미 있는 HTML과 키보드·포커스 기본 동작을 유지하는가? 모바일 및 필요한 반응형 범위를 확인했는가? 불필요한 공통화와 파일 분리가 없는가? 공통·재사용 컴포넌트를 새로 만들거나 공개 API를 변경했다면 Story를 작성 또는 갱신했는가? 해당되는 경우 정적 Storybook 빌드를…",
    "content": "9. 완료 기준 기존 컴포넌트와 디자인 토큰을 우선 사용했는가? 화면의 주요 구조와 상태가 Figma 의도와 일치하는가? 의미 있는 HTML과 키보드·포커스 기본 동작을 유지하는가? 모바일 및 필요한 반응형 범위를 확인했는가? 불필요한 공통화와 파일 분리가 없는가? 공통·재사용 컴포넌트를 새로 만들거나 공개 API를 변경했다면 Story를 작성 또는 갱신했는가? 해당되는 경우 정적 Storybook 빌드를 통과하는가? TypeScript 검사, lint와 production build를 통과하는가? AI 또는 Figma에서 생성한 코드는 사람이 작성한 코드와 같은 리뷰와 검증 기준을 적용합니다. React Code Exports 가이드",
    "url": "./../ui_guide/react_code_exports.html#section-9"
  },
  {
    "document": "React Code Exports 가이드",
    ...
    "url": "./../ui_guide/react_code_exports.html#section-2"
  },
  {
    "document": "React Code Exports 가이드",
    "section": "컴포넌트와 파일 분리",
    ...
    "content": "8. 컴포넌트와 파일 분리 파일은 Figma의 Frame이나 Group 수, JSX 길이 또는 Tailwind 클래스 수가 아니라 역할, 상태 소유권, 재사용 범위와 변경 이유를 기준으로 나눕니다. 사용 범위 기본 배치 한 부모에서만 사용하는 단순 UI 부모 컴포넌트 파일 특정 기능에서 사용하는 UI 해당 feature 내부 하나의 애플리케이션에서 반복되는 UI 애플리케이션 공통 컴포넌트 영역 여러 애플리케이션에서 의미와 변경 이유가 같은 UI 공통 UI 패키지 단순한 화면은 적은 파일로 시작합니다. 독립적인 동작, 상태, 주요 조건 분기 또는 실제 재사용이 확인될 때 컴포넌트를 분리합니다. 필요가 확인되지 않은 wrapper, hook, store, variant 또는 별도 타입 파일을 미리 만들지 않습니다. 8.1 Storybook 등록 기준 Storybook은 구현된 컴포넌트의 목록, 사용법과 주요 상태를 확인하는 개발 문서로 운영합니다. AI 도구는 Story 초안 작성, 누락 점검과 빌드 확인을 지원할 수 있지만, 등록 대상과 실제 상태의 정확성은 프론트엔드 개발자가 검수합니다. apps/app-webview/src/components/ui , packages/ui 와 독립적으로 재사용되는 기능 컴포넌트를 우선 등록합니다. 실제 export와 Props를 기준으로 기본 상태, variant, size, disabled, loading, error와 empty 중 구현된 상태만 Story로 작성합니다. 공개 Props, variant 또는 시각적 상태를 변경한 작업에서는 관련 Story도 같은 변경에 포함합니다. 페이지 전체, 한 번만 쓰는 단순 레이아웃, 타입·상수·도우미 파일과 과도한 Mock이 필요한 내부 컴포넌트는 기본 등록 대상에서 제외합니다. Storybook을 위해 제품 코드에 사용하지 않는 Props, variant, wrapper나 Mock 전용 구조를 추가하지 않습니다. Story가 없는 컴포넌트를 AI로 점검할 때는 파일 수만 비교하지 않고 대상, 근거와 제외 사유를 먼저 확인한 뒤 필요한 Story만 추가합니다.",
    "url": "./../ui_guide/react_code_exports.html#section-8"
  },
  {
    "document": "React Code Exports 가이드",
    "section": "토큰과 컴포넌트 사용",
  ...
  },
  {
    ...
    "url": "./../ui_guide/react_code_exports.html#section-6"
  },
  {
    "document": "React Code Exports 가이드",
  ...
  },
  {
    ...
    "content": "4. 기본 구성 Storybook은 먼저 apps/app-webview 에서 작은 범위로 도입합니다. 여러 애플리케이션에서 실제 공유되는 UI와 운영 필요성이 확인된 뒤 별도 Storybook Application 또는 공통 구성을 검토합니다. Next.js 프로젝트에서는 설치된 Next.js, React, Node.js와 Build 설정을 확인한 뒤 호환되는 Storybook Framework를 선택합니다. 특별한 Webpack 또는 Babel 제약이 없다면 공식 문서에서 권장하는 Next.js Vite Framework를 우선 검토합니다. 기본 기능은 다음 범위로 제한합니다. Component Story Format 기반 Story Controls와 Autodocs 접근성 검사 Storybook 정적 Build 실제 필요가 확인된 상호작용 테스트 유료 호스팅과 시각적 회귀 서비스는 기본 구성에 포함하지 않습니다. 팀 외부 공유, Pull Request 단위 시각 비교와 변경 승인 흐름이 실제로 필요해진 뒤 별도로 검토합니다. 자세한 설치 기준은 Storybook 설치 문서 와 Next.js Vite Framework 문서 를 확인합니다.",
    "url": "./../storybook_guide/index.html#section-4"
  },
  {
    "document": "Storybook 운영 가이드",
    "section": "목적과 범위",
    "excerpt": "Storybook은 공통 UI 컴포넌트의 목록, 공개 Props, variant와 주요 상태를 애플리케이션 화면과 분리해 확인하기 위해 사용합니다. Story 작성과 갱신은 AI 코딩 도구가 우선 수행하고 프론트엔드 개발자가 대상, 상태와 결과를 검수하는 반자동 운영을 기본으로 합니다. Storybook을 별도의 문서 작성 업무로 운영하지 않습니다. 공통 컴포넌트 생성과 변경 작업의 일부로…",
    "content": "1. 목적과 범위 Storybook은 공통 UI 컴포넌트의 목록, 공개 Props, variant와 주요 상태를 애플리케이션 화면과 분리해 확인하기 위해 사용합니다. Story 작성과 갱신은 AI 코딩 도구가 우선 수행하고 프론트엔드 개발자가 대상, 상태와 결과를 검수하는 반자동 운영을 기본으로 합니다. Storybook을 별도의 문서 작성 업무로 운영하지 않습니다. 공통 컴포넌트 생성과 변경 작업의 일부로 Story를 함께 관리하며, 자동 검사로 코드와 Story의 불일치를 확인합니다. 정확한 Storybook 버전, Framework와 Addon 구성은 실제 애플리케이션의 package.json 과 Lock File을 기준으로 결정합니다. 애플리케이션 저장소가 생성되기 전에는 설치 또는 CI 적용이 완료된 것으로 간주하지 않습니다.",
    "url": "./../storybook_guide/index.html#section-1"
  },
  {
    "document": "Storybook 운영 가이드",
    "section": "애플리케이션 스타일 연결",
    "excerpt": "Storybook은 실제 애플리케이션과 같은 기준으로 컴포넌트를 렌더링해야 합니다. globals.css 와 Tailwind CSS 4 설정을 연결합니다. Semantic Token과 CSS Variable을 애플리케이션과 동일하게 사용합니다. 프로젝트의 import alias를 유지합니다. 실제 렌더링에 필요한 Font와 전역 Provider만 연결합니다. Router, Query, The…",
    "content": "5. 애플리케이션 스타일 연결 Storybook은 실제 애플리케이션과 같은 기준으로 컴포넌트를 렌더링해야 합니다. globals.css 와 Tailwind CSS 4 설정을 연결합니다. Semantic Token과 CSS Variable을 애플리케이션과 동일하게 사용합니다. 프로젝트의 import alias를 유지합니다. 실제 렌더링에 필요한 Font와 전역 Provider만 연결합니다. Router, Query, Theme 또는 Form Context는 해당 컴포넌트에 필요한 최소 범위로 제공합니다. 전체 애플리케이션 환경을 재현하기 위한 과도한 Mock과 Provider를 만들지 않습니다. Storybook과 실제 화면의 스타일이 다르면 Story를 임의로 보정하지 않고 전역 스타일, Token, Provider와 Build 설정의 차이를 먼저 확인합니다.",
    "url": "./../storybook_guide/index.html#section-5"
  },
  {
    "document": "Storybook 운영 가이드",
    "section": "역할",
    "excerpt": "담당 주요 책임 AI 코딩 도구 기존 컴포넌트와 Story 조사, Story 초안 생성과 갱신, Autodocs 연결, 검사 실행 및 오류 수정 프론트엔드 개발자 Story 작성 대상 승인, 제품에 필요한 상태 판단, Figma 비교, 접근성과 상호작용 검수 CI Story 누락 검사, Storybook 정적 Build와 합의된 테스트 실행 Cline, Claude Code와 Codex 중…",
    "content": "2. 역할 담당 주요 책임 AI 코딩 도구 기존 컴포넌트와 Story 조사, Story 초안 생성과 갱신, Autodocs 연결, 검사 실행 및 오류 수정 프론트엔드 개발자 Story 작성 대상 승인, 제품에 필요한 상태 판단, Figma 비교, 접근성과 상호작용 검수 CI Story 누락 검사, Storybook 정적 Build와 합의된 테스트 실행 Cline, Claude Code와 Codex 중 어떤 도구를 사용하더라도 동일한 기준을 적용합니다. 도구 공통 규칙은 실제 애플리케이션 저장소의 AGENTS.md 를 기준으로 관리하고 특정 도구 전용 설정에는 공통 규칙을 복제하지 않습니다.",
    "url": "./../storybook_guide/index.html#section-2"
  },
  {
    "document": "Storybook 운영 가이드",
    "section": "완료 기준",
    "excerpt": "Story가 실제 컴포넌트의 export, Props와 variant를 사용하는가? 기본 상태와 제품에서 실제로 지원하는 주요 상태가 포함되어 있는가? Story를 위해 불필요한 제품 Props, variant 또는 Mock을 추가하지 않았는가? Tailwind CSS, Semantic Token, Font와 필요한 Provider가 실제 애플리케이션과 일치하는가? Autodocs에서 공개…",
    "content": "11. 완료 기준 Story가 실제 컴포넌트의 export, Props와 variant를 사용하는가? 기본 상태와 제품에서 실제로 지원하는 주요 상태가 포함되어 있는가? Story를 위해 불필요한 제품 Props, variant 또는 Mock을 추가하지 않았는가? Tailwind CSS, Semantic Token, Font와 필요한 Provider가 실제 애플리케이션과 일치하는가? Autodocs에서 공개 API를 확인할 수 있는가? Storybook 정적 Build와 합의된 검사를 통과하는가? Figma, Story와 실제 코드가 충돌하는 경우 차이를 확인하고 함께 갱신했는가? AI가 만든 결과를 프론트엔드 개발자가 검수했는가? Storybook과 AI 코딩 도구는 공통 UI의 발견과 유지보수 비용을 줄이는 작업 도구입니다. 생성된 Story는 사람이 작성한 코드와 같은 리뷰 및 검증 기준을 적용합니다. Storybook 운영 가이드",
    "url": "./../storybook_guide/index.html#section-11"
  },
  {
    "document": "Storybook 운영 가이드",
    "section": "자동 검사와 CI",
    ...
    "content": "10. 자동 검사와 CI AI 지침은 작업 방식을 안내하고 자동 검사는 결과를 확인합니다. Cline, Claude Code, Codex 또는 사람이 직접 작업하더라도 동일한 검사를 적용합니다. TypeScript 검사 → Lint → Storybook 정적 Build → 합의된 Story 테스트 → 필요한 Production Build 처음에는 Storybook 정적 Build를 필수 검사로 사용합니다. 파일럿이 안정된 뒤 Story 렌더링, 상호작용과 접근성 검사를 CI 필수 항목으로 승격합니다. 공통 UI 경로에서 Story 누락을 자동 검사할 때 모든 .tsx 파일을 일괄 대상으로 간주하지 않습니다. 컴포넌트 파일 규칙과 제외 대상을 명확히 정의하거나 공개 export 목록을 기준으로 검사합니다.",
    "url": "./../storybook_guide/index.html#section-10"
  },
  {
    "document": "Storybook 운영 가이드",
    "section": "AI를 이용한 반자동 운영",
    "excerpt": "9.1 최초 도입 최초 도입 시 AI 코딩 도구가 지정된 공통 UI 경로를 조사해 다음 내용을 먼저 보고합니다. 확인 항목 내용 컴포넌트 실제 export된 컴포넌트 이름 Story 상태 Story 존재, 누락 또는 실제 코드와 불일치 작성 필요성 Story 작성 대상 여부와 근거 주요 상태 실제 Props와 variant에서 확인된 상태 제외 사유 타입, helper, 내부 구현 또는 단순…",
    "content": "9. AI를 이용한 반자동 운영 9.1 최초 도입 최초 도입 시 AI 코딩 도구가 지정된 공통 UI 경로를 조사해 다음 내용을 먼저 보고합니다. 확인 항목 내용 컴포넌트 실제 export된 컴포넌트 이름 Story 상태 Story 존재, 누락 또는 실제 코드와 불일치 작성 필요성 Story 작성 대상 여부와 근거 주요 상태 실제 Props와 variant에서 확인된 상태 제외 사유 타입, helper, 내부 구현 또는 단순 Wrapper 등 목록을 사람이 검토한 뒤 승인된 컴포넌트만 Story로 작성합니다. 처음부터 모든 .tsx 파일에 Story를 생성하지 않습니다. Button, Input, Card, Dialog와 Badge처럼 단순하고 반복 사용되는 공통 UI부터 파일럿을 진행합니다. 9.2 일상적인 변경 flowchart LR accTitle: AI를 이용한 Storybook 반자동 운영 흐름 accDescr: 공통 컴포넌트를 생성하거나 변경하면 AI가 기존 Story와 사용처를 확인하고 Story를 갱신한 뒤 자동 검사와 프론트엔드 개발자 검수를 거칩니다. A[\"컴포넌트 생성 또는 변경\"] --> B[\"AI가 Story와 사용처 확인\"] B --> C[\"Story 생성 또는 갱신\"] C --> D[\"Autodocs와 주요 상태 확인\"] D --> E[\"Storybook Build와 관련 검사\"] E --> F[\"프론트엔드 개발자 검수\"] Story 생성·갱신과 검증 흐름 공통 컴포넌트를 새로 만들면 같은 변경에서 Story를 작성합니다. 공개 Props 또는 variant를 변경하면 기존 Story도 함께 갱신합니다. 컴포넌트 내부 구현만 바뀌고 공개 상태가 달라지지 않으면 불필요하게 Story를 다시 작성하지 않습니다. 완료 보고에는 추가하거나 변경한 Story, 표현한 상태, 검사 결과와 재현하지 못한 환경 의존성을 포함합니다. 9.3 정기 점검 필요할 때 AI 코딩 도구로 공통 UI와 Story의 누락 및 불일치를 조사합니다. 먼저 목록과 근거를 보고하고 승인된 항목만 수정합니다. Story가 필요한 공통 컴포넌트에 Story가 없는가? 삭제되거나 이름이 바뀐 Props와 variant가 Story에 남아 있는가? Story가 존재하지 않는 export나 import 경로를 사용하는가? 실제로 지원하지 않는 상태를 문서화하고 있는가? Storybook 렌더링을 위해 불필요한 제품 코드를 변경했는가? 9.4 AI 요청 예시 다음 요청은 Cline, Claude Code, Codex 등 사용하는 AI 코딩 도구와 관계없이 활용할 수 있습니다. 실제 경로와 프로젝트 검사 명령은 저장소 기준에 맞게 적용합니다. 최초 구축 또는 범위 확대 지정된 공통 UI 경로의 컴포넌트와 기존 Story를 조사해 줘. 각 컴포넌트의 실제 export, 공개 Props와 variant를 확인하고, Storybook 등록 대상과 제외 대상을 근거 및 제외 사유와 함께 먼저 보고해 줘. 모든 .tsx 파일을 등록 대상으로 간주하지 말고, 재사용 가능하며 독립적으로 상태를 확인할 가치가 있는 컴포넌트만 분류해 줘. 내가 목록을 확인한 뒤 승인한 컴포넌트에 대해서만 프로젝트의 기존 Story 형식에 맞춰 작성하고 정적 Storybook Build까지 확인해 줘. 일상적인 컴포넌트 변경 이번 변경에서 새로 생성되거나 공개 API가 변경된 공통 컴포넌트를 확인해 줘. 관련 기존 Story와 실제 사용처를 먼저 확인하고 필요한 Story만 작성하거나 갱신해 줘. 실제 export, Props와 variant만 사용하고 존재하지 않는 상태를 추측하지 마. 기본 상태와 제품에서 실제 지원하는 주요 상태를 표현하고, Storybook을 위해 제품 코드에 불필요한 Props, variant, wrapper 또는 Mock을 추가하지 마. 작업 후 정적 Storybook Build와 프로젝트에서 합의된 검사를 실행하고, 변경한 Story, 표현한 상태와 검사 결과를 보고해 줘. 정기 누락 및 불일치 점검 공통 UI 경로와 Storybook Story를 비교해 누락과 불일치를 점검해 줘. Story가 없는 모든 파일을 자동으로 등록하지 말고, 등록 대상, 판단 근거와 제외 사유를 먼저 보고해 줘. 삭제되거나 변경된 Props와 variant, 잘못된 import와 export, 실제로 지원하지 않는 상태 및 Storybook만을 위한 제품 코드 변경도 확인해 줘. 내가 승인한 항목만 수정하고 정적 Storybook Build와 관련 검사를 실행한 뒤 결과를 보고해 줘.",
    "url": "./../storybook_guide/index.html#section-9"
  },
  {
    "document": "Storybook 운영 가이드",
    "section": "Autodocs와 컴포넌트 문서",
    ...
    "content": "7. Autodocs와 컴포넌트 문서 Autodocs를 사용해 Story와 TypeScript 정보에서 컴포넌트 문서를 생성합니다. Props 전체 목록을 별도 Markdown 문서에 중복 작성하지 않습니다. Storybook은 다음 질문의 기준으로 사용합니다. 어떤 공통 컴포넌트가 있는가? 컴포넌트가 어떤 Props와 variant를 제공하는가? 기본 상태와 주요 예외 상태가 어떻게 보이는가? 컴포넌트를 독립적으로 렌더링하고 조작할 수 있는가? 컴포넌트의 업무 목적, 사용 금지 조건이나 접근성 제약처럼 타입에서 알 수 없는 내용만 짧게 추가합니다. 자세한 동작은 실제 컴포넌트 코드와 사용처를 기준으로 합니다. Autodocs 설정은 Storybook Autodocs 문서 를 따릅니다.",
    "url": "./../storybook_guide/index.html#section-7"
  },
  {
    "document": "Storybook 운영 가이드",
    "section": "Figma와 Storybook의 역할",
    "excerpt": "Figma는 컴포넌트의 시각적 기준과 디자인 의도를 제공하고 Storybook은 실제 코드 컴포넌트의 공개 API와 렌더링 상태를 제공합니다. Figma Main Component의 Description에는 코드 컴포넌트 이름, import 경로와 주요 Props를 기록합니다. 실제 코드 또는 Storybook에 접근할 수 있는 URL이 있으면 Main Component의 Dev resour…",
    "content": "8. Figma와 Storybook의 역할 Figma는 컴포넌트의 시각적 기준과 디자인 의도를 제공하고 Storybook은 실제 코드 컴포넌트의 공개 API와 렌더링 상태를 제공합니다. Figma Main Component의 Description에는 코드 컴포넌트 이름, import 경로와 주요 Props를 기록합니다. 실제 코드 또는 Storybook에 접근할 수 있는 URL이 있으면 Main Component의 Dev resource로 연결합니다. 외부 Storybook URL이 없으면 컴포넌트 이름과 Story title을 기록하고 실제 소스 링크를 우선 연결합니다. Figma Description, Story와 실제 코드가 다르면 실제 코드와 변경 의도를 확인한 뒤 함께 갱신합니다. Storybook은 Code Connect를 대체하지 않지만 AI 코딩 도구와 개발자가 기존 컴포넌트의 API와 상태를 확인하는 보조 기준으로 사용합니다.",
    "url": "./../storybook_guide/index.html#section-8"
  },
  {
    "document": "Storybook 운영 가이드",
    "section": "Story 작성 기준",
    "excerpt": "Story 파일은 컴포넌트 가까이에 둡니다. button.tsx button.stories.tsx Story는 실제 컴포넌트의 공개 API를 기준으로 작성합니다. 기본 상태를 작성합니다. 실제로 지원하는 주요 variant와 size를 작성합니다. disabled , loading , error , empty 처럼 컴포넌트가 실제로 소유하는 상태만 작성합니다. 중요한 사용자 상호작용은 재현…",
    "content": "6. Story 작성 기준 Story 파일은 컴포넌트 가까이에 둡니다. button.tsx button.stories.tsx Story는 실제 컴포넌트의 공개 API를 기준으로 작성합니다. 기본 상태를 작성합니다. 실제로 지원하는 주요 variant와 size를 작성합니다. disabled , loading , error , empty 처럼 컴포넌트가 실제로 소유하는 상태만 작성합니다. 중요한 사용자 상호작용은 재현 가능한 경우에만 작성합니다. 존재하지 않는 Props와 상태를 추측하지 않습니다. 내부 구현 세부사항보다 사용자가 선택할 수 있는 공개 API를 보여줍니다. 테스트를 통과시키기 위해 Story를 삭제하거나 검사 대상에서 임의로 제외하지 않습니다.",
    "url": "./../storybook_guide/index.html#section-6"
  },
  {
    "document": "Storybook 운영 가이드",
    "section": "Story 작성 대상",
    "excerpt": "다음 컴포넌트를 우선 대상으로 합니다. apps/app-webview/src/components/ui 의 공통 UI packages/ui 의 여러 Web 애플리케이션 공통 UI 여러 화면에서 반복되며 독립적으로 상태를 확인할 가치가 있는 feature 컴포넌트 공개 Props, variant 또는 상호작용 상태를 가진 컴포넌트 다음 항목에는 Story 작성을 기본적으로 강제하지 않습니다. N…",
    "content": "3. Story 작성 대상 다음 컴포넌트를 우선 대상으로 합니다. apps/app-webview/src/components/ui 의 공통 UI packages/ui 의 여러 Web 애플리케이션 공통 UI 여러 화면에서 반복되며 독립적으로 상태를 확인할 가치가 있는 feature 컴포넌트 공개 Props, variant 또는 상호작용 상태를 가진 컴포넌트 다음 항목에는 Story 작성을 기본적으로 강제하지 않습니다. Next.js Page와 전체 화면 한 부모에서만 사용하는 단순 UI와 레이아웃 타입, 상수, utility, helper와 export 전용 파일 독립 렌더링을 위해 과도한 Mock이 필요한 내부 구현 실제 재사용이나 독립 검증 필요성이 확인되지 않은 Wrapper Storybook을 위해 사용하지 않는 Props, variant 또는 상태를 새로 만들지 않습니다.",
    "url": "./../storybook_guide/index.html#section-3"
  },
  {
    "document": "TypeScript 가이드",
    "section": "문서 목적",
    "excerpt": "이 문서는 Front-End 프로젝트에서 TypeScript와 React를 간결하고 일관되게 사용하는 기준을 제공합니다. 문법이나 상세 설계를 모두 설명하지 않고, 코드 작성과 리뷰에 자주 필요한 규칙을 예시 중심으로 정리합니다. 전체 구조는 Front-End Monorepo 공통 기준 , Front-End 기술과 책임은 Front-End 개발 가이드 를 참고합니다. 현재 폴더 구조는 확정안…",
    "content": "1. 문서 목적 이 문서는 Front-End 프로젝트에서 TypeScript와 React를 간결하고 일관되게 사용하는 기준을 제공합니다. 문법이나 상세 설계를 모두 설명하지 않고, 코드 작성과 리뷰에 자주 필요한 규칙을 예시 중심으로 정리합니다. 전체 구조는 Front-End Monorepo 공통 기준 , Front-End 기술과 책임은 Front-End 개발 가이드 를 참고합니다. 현재 폴더 구조는 확정안이 아니므로 이 문서에서 별도 경로를 고정하지 않습니다. API 계약, 데이터 모델 계층, Runtime Schema와 상태 관리 도구의 상세 규칙은 현재 범위에 포함하지 않으며, 각 설계가 확정된 후 기준을 정합니다.",
    "url": "./../typescript_guide/index.html#section-1"
  },
  {
    "document": "TypeScript 가이드",
    "section": "추후 확정 항목",
    ...
    "url": "./../typescript_guide/index.html#section-9"
  },
  {
    "document": "TypeScript 가이드",
    "section": "코드 리뷰 체크리스트",
    ...
    "url": "./../typescript_guide/index.html#section-8"
  },
  {
    "document": "TypeScript 가이드",
    "section": "타입 작성과 배치",
    ...
    "url": "./../typescript_guide/index.html#section-3"
  },
  {
    "document": "TypeScript 가이드",
    "section": "타입 표현 방법",
    ...
    "url": "./../typescript_guide/index.html#section-4"
  },
  {
    "document": "TypeScript 가이드",
    "section": "피해야 할 타입 사용",
    ...
    "url": "./../typescript_guide/index.html#section-6"
  },
  {
    "document": "TypeScript 가이드",
    "section": "핵심 원칙",
    ...
    "url": "./../typescript_guide/index.html#section-2"
  },
  {
    "document": "TypeScript 가이드",
    ...
    "url": "./../typescript_guide/index.html#section-7"
  },
  {
    "document": "TypeScript 가이드",
    ...
    "url": "./../typescript_guide/index.html#section-5"
  },
  {
    ...
    "url": "./../ui_guide/zustand.html#section-1"
  },
  {
    "document": "Zustand UI 상태 관리 가이드",
    "section": "참고 문서",
    ...
    "url": "./../ui_guide/zustand.html#section-13"
  },
  {
    "document": "Zustand UI 상태 관리 가이드",
    "section": "추후 확정 항목",
    ...
    "url": "./../ui_guide/zustand.html#section-12"
  },
  {
    "document": "Zustand UI 상태 관리 가이드",
    "section": "코드 리뷰 체크리스트",
    ...
    "url": "./../ui_guide/zustand.html#section-11"
  },
  {
    "document": "Zustand UI 상태 관리 가이드",
    "section": "피해야 할 패턴",
    ...
    "url": "./../ui_guide/zustand.html#section-10"
  },
  {
    "document": "Zustand UI 상태 관리 가이드",
    "section": "핵심 원칙",
    ...
    "url": "./../ui_guide/zustand.html#section-3"
  },
  {
    "document": "Zustand UI 상태 관리 가이드",
    ...
    "url": "./../ui_guide/zustand.html#section-8"
  },
  {
    "document": "Zustand UI 상태 관리 가이드",
    "section": "Persist 사용",
    ...
    "url": "./../ui_guide/zustand.html#section-9"
  },
  {
    "document": "Zustand UI 상태 관리 가이드",
    ...
    "url": "./../ui_guide/zustand.html#section-5"
  },
  {
    "document": "Zustand UI 상태 관리 가이드",
    ...
    "url": "./../ui_guide/zustand.html#section-6"
  },
  {
    "document": "Zustand UI 상태 관리 가이드",
    ...
    "url": "./../ui_guide/zustand.html#section-7"
  },
  {
    "document": "Zustand UI 상태 관리 가이드",
    "section": "Store 작성",
    ...
    "url": "./../ui_guide/zustand.html#section-4"
  },
  {
    "document": "Zustand UI 상태 관리 가이드",
    ...
    "url": "./../ui_guide/zustand.html#section-2"
  }
];
