...
- [`Front-end 구축 일정 산정 보고서`](./schedule/web.html)는 반응형 웹사이트 약 225개 화면 및 상태와 앱 WebView 166개 대응 범위를 기준으로 산정했습니다.
- Front-end는 시니어 2명 중 1명이 PL과 개발을 겸하는 구성에서 90~115근무일, 약 4.5~5.75개월로 정리했습니다.
- [`Flutter APP 구축 일정 산정 보고서`](./schedule/app.html)는 미들급 Flutter 개발자 1명이 AI를 적극 활용하는 조건에서 기능 구현 95~120근무일, 통합 QA와 출시 준비까지 120~155근무일로 정리했습니다.
