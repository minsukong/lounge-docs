...
- Gemma4는 커뮤니케이션, Soul 준수, 문서 리뷰와 범용 Agent 작업에 강점이 있는 것으로 정리했습니다.
- Qwen3.8 27B는 느리고 커뮤니케이션이 상대적으로 약하지만 Cline 코딩 작업에 강점이 있었고, Hermes에서는 과도한 Reasoning과 출력 불안정이 관찰됐습니다.
- GPT-OSS는 Hermes에서 안정적이고 범용성이 좋아 보였지만 Qwen3.8보다 코딩을 잘하는지는 아직 확인되지 않았습니다.
