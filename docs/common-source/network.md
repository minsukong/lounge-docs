...
Cookie·CSRF·CORS, Client Secret과 민감정보 전달은 [Front-End 보안과 개인정보 가이드](../guides/security/index.html)의 책임 구분을 함께 확인합니다. Front-end는 승인된 계약을 연결하고 브라우저 동작을 검증하며, 서버 방어와 정책 적용은 Backend·배포·보안 담당이 수행합니다.
