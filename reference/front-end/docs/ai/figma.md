...
- Figma 표현을 옮길 때 공통 CSS 하한인 Safari 15를 지키고, 지원되지 않는 최신 CSS 기반 Utility는 호환 가능한 기본 Utility로 바꿉니다.
...
- Safari 15와 프로젝트가 정한 지원 대상 구형 브라우저에서 핵심 정보, 입력, 이동과 상태 표현을 확인합니다.
