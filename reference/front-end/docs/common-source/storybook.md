...
6. Autodocs에서 컴포넌트 공개 API를 확인하고 Screen은 이름, 대표 상태와 Viewport 중심으로 설명합니다.
7. Storybook 정적 Build와 합의된 렌더링·접근성·Interaction·시각 회귀 검사를 실행합니다.
8. 실제 Application에서도 Routing, Backend, Native 연결과 전체 사용자 흐름을 별도로 확인합니다.
